...
<div class="main-container">
    <section class="flex-center page-top-banner">
        <img src="../public_files/images/accounts_funding/islamic_account_top_banner.jpg" alt="Islamic Account"
             class="mex-img-cover"/>
        <div class="container">
            <div class="row">
    ...
    <section class="table-background islamic">
        <div class="container">
            <div class="row">
    ...
    <section class="table-background request">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 mx-auto shadow-box bg-white">
                    <form action="https://www.multibankfx.com/form/islamicaccount?" name='islamic_account_form'
                          class='multibank-form  row-offset-5 row padding-20 justify-content-end new' method='post'
                          enctype='' id='islamic_account_form' target='' autocomplete='on'>
                        <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo0OTozMg=='/>
                        <input type='hidden' name='token'
                               value='$2y$10$oFHO8aPvMwr0YX.usYIKrObsUEza8N1IZL7zLOFCrns.ffqA9P5r2'/>
                        <input type='hidden' name='source'
                               value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:29] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:30] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:31] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:32] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/account/islamic-account?web=true'/>
                        <div class='form-group col-12 px-0 border-bottom border-secondary px-1'>
                            ...
                            <input type='hidden' data-message='' data-extra-message="Full Name Invalid." data-regex=''
                                   class=' form-control' name='label_title' placeholder='Full Name' value=''/>
                        </div>
                        <div class='mex-form-item col-12 col-md-6 p-1'>
                            ...
                            <input type="text" data-message="Name is Required." data-extra-message="Name is Invalid."
                                   data-regex="" class="d-block" name="name" $field_id_code placeholder="" required
                                   value=""/>
                        </div>
                        <div class='d-none'>
                            <label for='' class='d-block'>
                                Country</label>
                            <select data-message='' data-extra-message=""
                                    class='selection-country d-block select_with_country' name='country_name' required>
                        ...
                        <div class='mex-form-item col-12 col-md-6 p-1'>
                            ...
                            <input type='phone' data-ip_country_code='IN' data-message='Phone Number is required.'
                                   data-extra-message="Phone is Invalid." data-regex='' class='input_with_phone d-block'
                                   name='phone_display' placeholder='' required value=''/>
                        ...
                        <div class='mex-form-item col-12 col-md-6 p-1'>
                            ...
                            <input type='email' data-message='Email is Required.' data-extra-message="Email is Invalid."
                                   data-regex='null' class='d-block' name='email' placeholder='' required value=''/>
                        </div>
                        <div class='mex-form-item col-12 col-md-6 p-1'>
                            <label for='' class='d-block'>
                                Confirm Email</label>
                        ...
                        <button type='submit' class='btn btn-mex mx-auto mt-5 mb-2'
                                onsubmit="if (!window.__cfRLUnblockHandlers) return false; "
                                data-cf-modified-6f0d84ec5eaa22effb7ee8e8-="">SUBMIT
                        </button>
                    </form>
    ...
    <section class="flex-center page-top-banner">
        <img class="mex-img-cover" src="../public_files/images/accounts_funding/islamic_condition_bg.jpg"
             alt="Islamic Account Benefits">
        <div class="container">
            <div class="row">
    ...
    <section class="flex-center white-bg">
        <div class="container ">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                ...
                <div class="icon-next-list">
                    <ul class="bg-white target-icon">
                        ...
                        <li><a href="../index.html#"
                               ...
                               data-cf-modified-6f0d84ec5eaa22effb7ee8e8-=""><span
                                class="ico-ic_live_chat_support"></span> </a>
                            <div class="mex-content mex-clamp-3"><a href="../index.html#"
                                                                    onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                                                                    data-cf-modified-6f0d84ec5eaa22effb7ee8e8-="">Live
                                Chat Support</a></div>
                            <a href="../index.html#"
                               onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                               data-cf-modified-6f0d84ec5eaa22effb7ee8e8-=""> </a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script type="6f0d84ec5eaa22effb7ee8e8-text/javascript">
    $(function() {
//icons we need
        var icons = [
            'ic_why_multibank',
...
<div class="cc-country-selector">
    <div class="cc-country-selector--overlay"
         ...
         data-cf-modified-6f0d84ec5eaa22effb7ee8e8-=""></div>
    <div class="container">
        <div class="row">
                ...
                <div class="border-line col-md-6 col-lg-4 col-sm-12 col-xs-12">
                    <ul class="contact-social-media d-none d-md-block">
                        ...
                        <li class="ForIts">
                            ...
                            <div class="contact-email"><a class="text-000033"
                                                          href="../cdn-cgi/l/email-protection.html#1f7c6c5f726a736b767d7e71747967317c7072"><span
                                    class="__cf_email__" data-cfemail="beddcdfed3cbd2cad7dcdfd0d5d8c690ddd1d3">[email&#160;protected]</span></a>
                            </div>
                        </li>
                        <li class="ForIts">
                            <div class="mex-h3 mex-m-t-20 ">Live Chat</div>
                            <a href="islamic-account.html#"
                               onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                               data-cf-modified-6f0d84ec5eaa22effb7ee8e8-=""><img alt="chat"
                    ...
                    <div class="d-flex d-md-none row py-4 row-eq-height">
                        <div class="col-4 text-center mx-auto">
                            ...
                            <a href="../cdn-cgi/l/email-protection.html#a2c1d1e2cfd7ced6cbc0c3ccc9c4da8cc1cdcf">
                        ...
                        <div class="col-4 text-center mx-auto">
                            ...
                            <a href="islamic-account.html#"
                               onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                               data-cf-modified-6f0d84ec5eaa22effb7ee8e8-="">
                                <img class="footer-contact-ic"
                ...
                <div class="col-md-6 col-lg-4 col-sm-12 col-xs-12 d-none d-md-block">
                    ...
                    <div style="width: 100%;">
                        <form action="https://www.multibankfx.com/form/callback?" name='call_back_footer_form'
                            ...
                            <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo0OTozMg=='/>
                            <input type='hidden' name='token'
                                   value='$2y$10$OhpXCmh/qEsvYGd2HoGUaeioJYo6hAikFnfvNX755Nk5xal6M40Va'/>
                            <input type='hidden' name='source'
                                   value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:29] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:30] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:31] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:32] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/account/islamic-account?web=true'/>
                            ...
                            <button type='submit' class='btn btn-mex mx-auto'
                                    onsubmit="if (!window.__cfRLUnblockHandlers) return false; "
                                    data-cf-modified-6f0d84ec5eaa22effb7ee8e8-="">CALL ME
                            </button>
                        </form>
        ...
        <div class="col-lg-12 footer">
            <div class="row justify-content-between" style="padding-bottom: 25px; border-bottom: 1px solid #808080;">
                <div class="col-xs-12 col-sm-12 col-md-8 footer_other_left align-self-center">
                    ...
                    <a href="islamic-account.html#"
                       onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                       data-cf-modified-6f0d84ec5eaa22effb7ee8e8-="">Support</a>
...
<div class="slidebar">
    ...
    <a class="email-us-tg demo-account-btn email-btn"
       href="../cdn-cgi/l/email-protection.html#fd9e8ebd90889189949f9c93969b85d39e9290">
    ...
    <div class="container row">
        <div class="col-12 col-md-7 mx-auto bg-white p-4">
            ...
            <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form'
                  ...
                  autocomplete='on'>
                <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo0OTozMg=='/>
                <input type='hidden' name='token' value='$2y$10$3QK62Zk/kk4de6TK6xolG.Y/0QI7V5uYh2Xv6M2vBBNcGZMR5KHQK'/>
                <input type='hidden' name='source'
                       value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:29] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:30] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:31] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:32] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/account/islamic-account?web=true'/>
                ...
                <button type='submit' class='btn btn-mex ml-auto btn-submit'
                        onsubmit="if (!window.__cfRLUnblockHandlers) return false; "
                        data-cf-modified-6f0d84ec5eaa22effb7ee8e8-="">SEND
                </button>
            </form>
        </div>
    </div>
...
<script src="../public_files/static_js/lang_data/en.js" type="6f0d84ec5eaa22effb7ee8e8-text/javascript"></script>
...
<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="6f0d84ec5eaa22effb7ee8e8-|49" defer=""></script>
</body>
</html>