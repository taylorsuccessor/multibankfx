...
<div class="main-container">
    ...
    <section class="flex-center page-top-banner"><img src="../public_files/images/accounts_funding/bonus_top_banner.jpg"
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-sm-12"><h1 class="mex-h1 text-left"> BONUSES </h1>
                    ...
                    <div class="mex-m-t-15"><a href="bonus.html" class="btn btn-mex mex-m-r-15 mex-m-b-10">Individual
                        Clients</a> <a href="bonus-ib.html" class="btn btn-mex-gray mex-m-r-15 mex-m-b-10">Introducing
                        Broker</a></div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="home-banner-form" style="background: none;">
                <div class="mex-p-h-15" style="background-color: rgba(255, 255, 255, 0.75); padding-bottom: 15px;">
                    <form action="https://www.multibankfx.com/form/demoaccount?default_bonus=refer_bonus"
                          name='lp_campaign_07_16_v2' class='multibank-form row mx-0 w-100' method='post' enctype=''
                          id='lp_campaign_07_16_v2' target='' autocomplete='on'>
                        <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDowMA=='/>
                        <input type='hidden' name='token'
                               value='$2y$10$4BxGZhwRyCrKS8LTcDxwhuP1zocgopHe8vGAga5Nzi9.kKmv/qW.e'/>
                        <input type='hidden' name='source'
                               value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:52] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:53] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:54] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:00] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/account/bonus?default_bonus=refer_bonus'/>
                        ...
                        <div class='px-1 font-10'>
                            ...
                            <div class='form-check form-check-inline'>
                                ...
                                <label class='form-check-label label-1 ' for='terms_conditions'>I accept the <a
                                        href="../terms-conditions.html" target="_blank" class="text-22A0C4">Terms &
                                    Conditions</a>, <a href="../privacy-policy.html" target="_blank"
                                                       class="text-22A0C4">Privacy Policy</a>, and <a
                                        href="../cookie-policy.html" target="_blank" class="text-22A0C4">Cookie
                                    Policy</a>.</label>
                            </div>
                        </div>
                        <div class=''>
                        ...
                        <button type='submit' class='btn-contact mx-1 mt-2 mb-0'
                                ...
                                data-cf-modified-448f41c34414c25003e81c4d-="">OPEN DEMO ACCOUNT
                        </button>
                    </form>
                ...
                <div class="col-md-12 col-sm-12">
                    <div id="bonus_container" class="bounes-clients-tab">
                        ...
                        <div class="tab-content have-box-shadow col-12 mex-content">
                            <div class="tab-pane active bonus-page-pane" id="100_bonus">
                            ...
                            <div class="tab-pane bonus-page-pane" id="imperial_bonus">
                            ...
                            <div class="tab-pane bonus-page-pane" id="refer_bonus">
                                <h2 class="mex-h1 text-1e32a3 mex-m-t-15 uppercase text-left">REFER A FRIEND BONUS</h2>
                                <p class="mex-m-b-20">Spread the word about MultiBank Group and earn money for you and
                                    every friend that you introduce to us!</p>
                                <h4>Earn money by introducing a friend.</h4>
                                <div class="col-xs-12 mex-m-b-30">
                                    <div class="table-responsive mex-xs-p-none">
                                        <table class="table table-striped mex-table mex-has-type text-center">
                                            <thead>
                                            <tr>
                                                <th class="text-center">Friend’s <br>Initial Deposit</th>
                                                <th class="text-center">Your Bonus</th>
                                                <th class="text-center">Friend’s Bonus</th>
                                                <th class="text-center">Lots RT Target <br>to be reached by friend</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr>
                                ...
                                <h4>Terms &amp; Conditions</h4>
                                <ul class="mex-list-conditions mex-m-t-15">
                                    <li>1. Lots RT Target must be reached by friend within 3 months of friend’s initial
                                        deposit to qualify for this Refer a Friend Bonus
                                    </li>
                                    <li>2. Once the above conditions have been met, the bonus amounts will be credited
                                        to you and your friend’s MultiBank trading accounts within 5-7 business days
                                        respectively
                                    </li>
                                    <li>3. The referred friend must be a first-time new clients with MultiBank Group and
                                        cannot be an existing client
                                    </li>
                                    <li>4. The minimum initial deposit amount by friend must be $1,000</li>
                                    <li>5. Each person can qualify for up to 8 Refer a Friend Bonus each calendar year
                                    </li>
                                    <li>6. This bonus is non-rebate generating</li>
                                    <li>7. This bonus shall be automatically deducted in case withdrawals are made
                                        before the lots round-trip target is reached
                                    </li>
                                    <li>8. Manipulation of the system by arbitrage trading is strictly prohibited</li>
                                    <li>9. MultiBank Group reserves the right to correct the trading calculation in the
                                        event of any suspected abuse or manipulation of this bonus policy and promotion
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="icon-next-list">
                    <ul class="bg-white target-icon">
                        ...
                        <li><a href="../index.html#"
                               ...
                               data-cf-modified-448f41c34414c25003e81c4d-=""><span
                                class="ico-ic_live_chat_support"></span> </a>
                            <div class="mex-content mex-clamp-3"><a href="../index.html#"
                                                                    onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                                                                    data-cf-modified-448f41c34414c25003e81c4d-="">Live
                                Chat Support</a></div>
                            <a href="../index.html#"
                               onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                               data-cf-modified-448f41c34414c25003e81c4d-=""> </a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="cc-country-selector">
    <div class="cc-country-selector--overlay"
         ...
         data-cf-modified-448f41c34414c25003e81c4d-=""></div>
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-7 mx-auto cc-country-selector--box">
                ...
                <button type="button" class="cc-country-selector--submit--btn"
                        ...
                        data-cf-modified-448f41c34414c25003e81c4d-="">Submit
                </button>
            </div>
        </div>
    </div>
                ...
                <div class="border-line col-md-6 col-lg-4 col-sm-12 col-xs-12">
                    <ul class="contact-social-media d-none d-md-block">
                        ...
                        <li class="ForIts">
                            ...
                            <div class="contact-email"><a class="text-000033"
                                                          href="../cdn-cgi/l/email-protection.html#24475764495148504d46454a4f425c0a474b49"><span
                                    class="__cf_email__" data-cfemail="04677744697168706d66656a6f627c2a676b69">[email&#160;protected]</span></a>
                            </div>
                        </li>
                        <li class="ForIts">
                            <div class="mex-h3 mex-m-t-20 ">Live Chat</div>
                            <a href="bonus%3Fdefault_bonus=refer_bonus.html#"
                               onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                               data-cf-modified-448f41c34414c25003e81c4d-=""><img alt="chat"
                    ...
                    <div class="d-flex d-md-none row py-4 row-eq-height">
                        <div class="col-4 text-center mx-auto">
                            ...
                            <a href="../cdn-cgi/l/email-protection.html#7e1d0d3e130b120a171c1f10151806501d1113">
                ...
                <div class="col-md-6 col-lg-4 col-sm-12 col-xs-12 d-none d-md-block">
                    ...
                    <div style="width: 100%;">
                        <form action="https://www.multibankfx.com/form/callback?" name='call_back_footer_form'
                            ...
                            <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDowMA=='/>
                            <input type='hidden' name='token'
                                   value='$2y$10$FtirXiT3zLvNY9ZzrXTO3u/Im0jl2Ql1VZNVl3qZrv2k56nnamriK'/>
                            <input type='hidden' name='source'
                                   value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:52] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:53] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:54] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:00] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/account/bonus?default_bonus=refer_bonus'/>
                            <div class='mex-form-item col-6 p-1 cb-partnership font-16 text-center'>
                                <label for='' class='m-0'>
                            ...
                            <button type='submit' class='btn btn-mex mx-auto'
                                    onsubmit="if (!window.__cfRLUnblockHandlers) return false; "
                                    data-cf-modified-448f41c34414c25003e81c4d-="">CALL ME
                            </button>
                        </form>
        ...
        <div class="col-lg-12 footer">
            <div class="row justify-content-between" style="padding-bottom: 25px; border-bottom: 1px solid #808080;">
                <div class="col-xs-12 col-sm-12 col-md-8 footer_other_left align-self-center">
                    ...
                    <a href="bonus%3Fdefault_bonus=refer_bonus.html#"
                       onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                       data-cf-modified-448f41c34414c25003e81c4d-="">Support</a>
...
<div class="modal-box__email-us">
    <div class="container row">
        <div class="col-12 col-md-7 mx-auto bg-white p-4">
            ...
            <form action="https://www.multibankfx.com/form/contactus?default_bonus=refer_bonus" name='email_us_form'
                  class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target=''
                  autocomplete='on'>
                <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDowMA=='/>
                <input type='hidden' name='token' value='$2y$10$yo6wxlnjbNXdsdfbuaII4e2NWmQXi.orfCUlJDNe.K07lQ6sRnB8W'/>
                <input type='hidden' name='source'
                       value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:52] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:53] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:54] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:00] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/account/bonus?default_bonus=refer_bonus'/>
                ...
                <button type='submit' class='btn btn-mex ml-auto btn-submit'
                        onsubmit="if (!window.__cfRLUnblockHandlers) return false; "
                        data-cf-modified-448f41c34414c25003e81c4d-="">SEND
                </button>
            </form>
        </div>
    </div>
...
<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="448f41c34414c25003e81c4d-|49" defer=""></script>
</body>
</html>