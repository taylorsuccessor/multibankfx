...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-12 ">
                        <h1 class="mex-h1 text-left"> <?php translate('ACCOUNT FORMS'); ?> </h1>
                        <div class="mex-content mex-m-b-30">
                            <p class="mex-m-t-15"><?php translate('If you’d like to submit a change of
                        ...
                        <div class="mex-content mex-m-b-30">
                            ...
                            <a href="/multibankfx/demo_competition.php" class="btn btn-mex-blue mex-m-r-15 mex-m-b-15 col-xs-12 col-sm-6"><?php translate('Open Demo Account'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container mx-xs-10 w-xs-100">
                <div class="row">
                    ...
                    <div class="col-12 mex-m-t-30">
                        <div class="col-12 col-lg-10 col-xl-8 mx-auto">
                            <div class="table-responsive">
                                <table class="table mex-table table-easy shadow-box account-forms-table" id="exchange_table">
                                    <thead>
                                        <tr>
                                            <th colspan="2"><?php translate('MEX EXCHANGE (Regulated by ASIC)'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/MEX_Client_Agreement.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Financial Services Guide'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/MEX_Exchange_Financial_Services_Guide.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Product Disclosure Statement'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/MEX_Exchange_Produc_Disclosure_Statement.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Individual Account Application'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/MEX_Exchange_Individual_Account_Application.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Corporate Account Application'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/MEX_Exchange_Corporate_Account_Application.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Joint Account Application'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/MEX_Exchange_Joint_Account_Application.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Broker-to-Broker (B2B) Transfer Authorization Form'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/MEX_Exchange_Broker-to-Broker_Transfer_Authorisation.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Transaction Fee Terms'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/MEX_Australia_Transaction_Fee_Terms.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Change of Information Request'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/pdf/MEX_Exchange_en/MEX_Exchange_Change_of_Information.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Additional Account Request'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/MEX_Exchange_Additional_Account_Request.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('VPS Client Agreement'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/MEX_Exchange_VPS_Client_Agreement.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Power of Attorney & Discretionary Account Terms'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/MEX_Exchange_Power_of_Attorney_and_Discretionary_Account_Terms.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Fund Withdrawal Form'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/MEX_Exchange_Fund_Withdrawal_Form.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="col-12 mex-m-t-30">
                        <div class="col-12 col-lg-10 col-xl-8 mx-auto">
                            <div class="table-responsive">
                                <table class="table mex-table shadow-box table-easy account-forms-table" id="multibank_table">
                                    <thead>
                                        <tr>
                                            <th colspan="2"><?php translate('MULTIBANK FX INTERNATIONAL (Regulated by FSC)'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody class="">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/MultiBank-FX-International-Client-Agreement.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Individual Account Application'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/Multibank_FX_Individual_Account_Application.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Corporate Account Application'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/Multibank_FX_Corporate_Account_Application.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Broker-to-Broker (B2B) Transfer Authorization Form'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/Multibank_FX_Broker-to-Broker_Transfer_Authorisation.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Change of Information Request'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/Multibank_FX_Change_of_Information.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Additional Account Request'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/Multibank_FX_Additional_Account_Request.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('VPS Client Agreement'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/Multibank_FX_VPS_Client_Agreement.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Power of Attorney & Discretionary Account Terms'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/Multibank_FX_Power_of_Attorney_and_Discretionary_Account_Terms.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Fund Withdrawal Form'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/Multibank_FX_Fund_Withdrawal_Request.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                        <tr>
                                            <td><?php translate('Transfer of Funds Aut Form'); ?></td>
                                            <td>
                                                <a href="/multibankfx/public_files/images/documents/pdf/account-forms/Transfer_of_Funds_Aut_Form.pdf" target="_blank" class="btn btn-mex"><?php translate('DOWNLOAD'); ?></a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="icon-next-list">
                        <ul class="bg-white target-icon">
                            <li><a href="/multibankfx/platforms/download-center.php"><span class="ico-ic_download_mt4"></span> </a>
                                <div class="mex-content mex-clamp-3"><a href="/multibankfx/platforms/download-center.php"><?php translate('Download MT4'); ?></a></div>
    ...
    <div class="cc-country-selector">
        <div class="cc-country-selector--overlay" onclick="if (!window.__cfRLUnblockHandlers) return false; closeCountrySelectionDialog()" data-cf-modified-692f5fcd51892006519a947c-=""></div>
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-7 mx-auto cc-country-selector--box">
                    ...
                    <button type="button" class="cc-country-selector--submit--btn" onclick="if (!window.__cfRLUnblockHandlers) return false; redirectCreditCard()" data-cf-modified-692f5fcd51892006519a947c-="">Submit
                    </button>
                </div>
            </div>
        </div>
   ...
   <?php include_from_root('website_template/page_footer.php');?>
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    ...
                    <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:32] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:33] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:35] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/account/account-forms?web=true' />
                    ...
                    <button type='submit' class='btn btn-mex ml-auto btn-submit' onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-692f5fcd51892006519a947c-="">SEND
                    </button>
                </form>
            </div>
        </div>
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="692f5fcd51892006519a947c-|49" defer=""></script>
</body>
