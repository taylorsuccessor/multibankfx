        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 mx-auto shadow-box bg-white">
                    <form action="https://www.multibankfx.com/form/demoaccount?" name='demo_account_form'
                          class='multibank-form  row-offset-5 row padding-20 justify-content-end new' method='post'
                          enctype='' id='demo_account_form' target='' autocomplete='on'>
                        <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo0OTowNg=='/>
                        <input type='hidden' name='token'
                               value='$2y$10$efbgMCtzi2GMqYgP2i0sTuiWSQOnUg9x2UBV75LL8Okjyy8ZKH0ay'/>
                        <input type='hidden' name='source'
                               value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:04] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:06] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/account/demo-account?web=true'/>
                        ...
                        <div class='d-none'>
                            <label for='' class='d-block text-333'>
                                Country</label>
                            <select data-message='Country is Required.' data-extra-message="Country Code Error."
                        ...
                        <div class='mex-form-item col-12 col-md-6 p-1 mb-2'>
                            <label for='' class='d-block text-333'>
                                Platform</label>
                            <select class='' data-message='Platform is Required.'
                                    data-extra-message="Platform is Invalid." data-regex='' name='platform_version'
                                    required>
                        ...
                        <button type='submit' class='btn btn-mex mx-auto mt-5 mb-2'
                                ...
                                data-cf-modified-11f25f6a1053fe5650fdae05-="">SUBMIT
                        </button>
                    </form>
                ...
                <div class="icon-next-list">
                    <ul class="bg-white target-icon">
                        ...
                        <li><a href="../index.html#"
                               ...
                               data-cf-modified-11f25f6a1053fe5650fdae05-=""><span
                                class="ico-ic_live_chat_support"></span> </a>
                            <div class="mex-content mex-clamp-3"><a href="../index.html#"
                                                                    onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                                                                    data-cf-modified-11f25f6a1053fe5650fdae05-="">Live
                                Chat Support</a></div>
                            <a href="../index.html#"
                               onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                               data-cf-modified-11f25f6a1053fe5650fdae05-=""> </a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script type="11f25f6a1053fe5650fdae05-text/javascript">
    $(function() {
//icons we need
        var icons = [
            'ic_why_multibank',
...
<div class="cc-country-selector">
    <div class="cc-country-selector--overlay"
         ...
         data-cf-modified-11f25f6a1053fe5650fdae05-=""></div>
    <div class="container">
        <div class="row">
                ...
                <div class="border-line col-md-6 col-lg-4 col-sm-12 col-xs-12">
                    <ul class="contact-social-media d-none d-md-block">
                        ...
                        <li class="ForIts">
                            ...
                            <div class="contact-email"><a class="text-000033"
                                                          href="../cdn-cgi/l/email-protection.html#95f6e6d5f8e0f9e1fcf7f4fbfef3edbbf6faf8"><span
                                    class="__cf_email__" data-cfemail="f29181b29f879e869b90939c99948adc919d9f">[email&#160;protected]</span></a>
                            </div>
                        </li>
                        <li class="ForIts">
                            ...
                            <a href="../demo_competition.html#"
                               onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                               data-cf-modified-11f25f6a1053fe5650fdae05-=""><img alt="chat"
                    ...
                    <div class="d-flex d-md-none row py-4 row-eq-height">
                        <div class="col-4 text-center mx-auto">
                            ...
                            <a href="../cdn-cgi/l/email-protection.html#462535062b332a322f2427282d203e6825292b">
                        ...
                        <div class="col-4 text-center mx-auto">
                            ...
                            <a href="../demo_competition.html#"
                               onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                               data-cf-modified-11f25f6a1053fe5650fdae05-="">
                                <img class="footer-contact-ic"
                ...
                <div class="col-md-6 col-lg-4 col-sm-12 col-xs-12 d-none d-md-block">
                    ...
                    <div style="width: 100%;">
                        <form action="https://www.multibankfx.com/form/callback?" name='call_back_footer_form'
                            ...
                            <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo0OTowNg=='/>
                            <input type='hidden' name='token'
                                   value='$2y$10$RyzZQtJWxZ1jfejEONvk..4Pw6YP.XhygxOm/HpgNa7rXYVCm3j4O'/>
                            <input type='hidden' name='source'
                                   value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:04] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:06] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/account/demo-account?web=true'/>
                            ...
                            <button type='submit' class='btn btn-mex mx-auto'
                                    onsubmit="if (!window.__cfRLUnblockHandlers) return false; "
                                    data-cf-modified-11f25f6a1053fe5650fdae05-="">CALL ME
                            </button>
                        </form>
        ...
        <div class="col-lg-12 footer">
            <div class="row justify-content-between" style="padding-bottom: 25px; border-bottom: 1px solid #808080;">
                <div class="col-xs-12 col-sm-12 col-md-8 footer_other_left align-self-center">
                    ...
                    <a href="../demo_competition.html#"
                       onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                       data-cf-modified-11f25f6a1053fe5650fdae05-="">Support</a>
...
<div class="slidebar">
    ...
    <a class="email-us-tg demo-account-btn email-btn"
       href="../cdn-cgi/l/email-protection.html#90f3e3d0fde5fce4f9f2f1fefbf6e8bef3fffd">
    ...
    <div class="container row">
        <div class="col-12 col-md-7 mx-auto bg-white p-4">
            ...
            <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form'
                  ...
                  autocomplete='on'>
                <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo0OTowNg=='/>
                <input type='hidden' name='token' value='$2y$10$ej7XcM8otKnixasPUDt.1Oxg087JRTqKQbAnTczIADqLsh6z9q57K'/>
                <input type='hidden' name='source'
                       value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:04] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:06] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/account/demo-account?web=true'/>
                ...
                <button type='submit' class='btn btn-mex ml-auto btn-submit'
                        onsubmit="if (!window.__cfRLUnblockHandlers) return false; "
                        data-cf-modified-11f25f6a1053fe5650fdae05-="">SEND
                </button>
            </form>
        </div>
    </div>
...
<script src="../public_files/static_js/lang_data/en.js" type="11f25f6a1053fe5650fdae05-text/javascript"></script>
<script src="../public_files/static_js/jquery.dataTables.min.js"
        type="11f25f6a1053fe5650fdae05-text/javascript"></script>
<script src="../public_files/static_js/lazysizes.min.js" type="11f25f6a1053fe5650fdae05-text/javascript"></script>
<script src="../public_files/static_js/jquery.validate.min.js" type="11f25f6a1053fe5650fdae05-text/javascript"></script>
...
<script src="../public_files/static_js/app.js%3Fversion=20200612"
        type="11f25f6a1053fe5650fdae05-text/javascript"></script>
<script type="11f25f6a1053fe5650fdae05-text/javascript" async>
...
<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="11f25f6a1053fe5650fdae05-|49" defer=""></script>
</body>
</html>