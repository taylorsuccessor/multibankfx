            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        ...
                        <div class="mex-m-t-15"><a href="bonus.html" class="btn btn-mex mex-m-r-15 mex-m-b-10"><?php translate('Individual Clients'); ?></a> <a href="bonus-ib.html" class="btn btn-mex-gray mex-m-r-15 mex-m-b-10"><?php translate('Introducing Broker'); ?></a></div>
                    </div>
                </div>
            </div>
        </section>
