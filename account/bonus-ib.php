...
<div class="cc-country-selector">
    <div class="cc-country-selector--overlay"
         ...
         data-cf-modified-9221275646d340e84872cc8a-=""></div>
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-7 mx-auto cc-country-selector--box">
                ...
                <button type="button" class="cc-country-selector--submit--btn"
                        ...
                        data-cf-modified-9221275646d340e84872cc8a-="">Submit
                </button>
            </div>
        </div>
    </div>
                ...
                <div class="border-line col-md-6 col-lg-4 col-sm-12 col-xs-12">
                    <ul class="contact-social-media d-none d-md-block">
                        ...
                        <li class="ForIts">
                            ...
                            <div class="contact-email"><a class="text-000033"
                                                          href="../cdn-cgi/l/email-protection.html#127161527f677e667b70737c79746a3c717d7f"><span
                                    class="__cf_email__" data-cfemail="731000331e061f071a11121d18150b5d101c1e">[email&#160;protected]</span></a>
                            </div>
                        </li>
                        <li class="ForIts">
                            <div class="mex-h3 mex-m-t-20 ">Live Chat</div>
                            <a href="bonus-ib.html#"
                               onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                               data-cf-modified-9221275646d340e84872cc8a-=""><img alt="chat"
                    ...
                    <div class="d-flex d-md-none row py-4 row-eq-height">
                        <div class="col-4 text-center mx-auto">
                            ...
                            <a href="../cdn-cgi/l/email-protection.html#accfdfecc1d9c0d8c5cecdc2c7cad482cfc3c1">
                ...
                <div class="col-md-6 col-lg-4 col-sm-12 col-xs-12 d-none d-md-block">
                    ...
                    <div style="width: 100%;">
                        <form action="https://www.multibankfx.com/form/callback?" name='call_back_footer_form'
                            ...
                            <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDowMQ=='/>
                            <input type='hidden' name='token'
                                   value='$2y$10$14YnmL3J7fB4D3c30OlRY.wNyPzP5TthDSeqgzjIYLtsi1XAI5TkG'/>
                            <input type='hidden' name='source'
                                   value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:53] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:54] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:00] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:01] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/account/bonus-ib?web=true'/>
                            ...
                            <button type='submit' class='btn btn-mex mx-auto'
                                    ...
                                    data-cf-modified-9221275646d340e84872cc8a-="">CALL ME
                            </button>
                        </form>
        ...
        <div class="col-lg-12 footer">
            <div class="row justify-content-between" style="padding-bottom: 25px; border-bottom: 1px solid #808080;">
                <div class="col-xs-12 col-sm-12 col-md-8 footer_other_left align-self-center">
                    ...
                    <a href="bonus-ib.html#"
                       onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;"
                       data-cf-modified-9221275646d340e84872cc8a-="">Support</a>
    ...
    <div class="container row">
        <div class="col-12 col-md-7 mx-auto bg-white p-4">
            ...
            <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form'
                  ...
                  autocomplete='on'>
                <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1MDowMQ=='/>
                <input type='hidden' name='token' value='$2y$10$kkeHGZpM7Rjgbz7geekgJuMGqoYllZtgMUOHyuVBiioZO9k2PaFPu'/>
                <input type='hidden' name='source'
                       value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:53] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:54] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:00] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:50:01] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/account/bonus-ib?web=true'/>
                ...
                <button type='submit' class='btn btn-mex ml-auto btn-submit'
                        onsubmit="if (!window.__cfRLUnblockHandlers) return false; "
                        data-cf-modified-9221275646d340e84872cc8a-="">SEND
                </button>
            </form>
        </div>
    </div>
...
<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="9221275646d340e84872cc8a-|49" defer=""></script>
</body>
</html>