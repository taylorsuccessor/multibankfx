...
<body>
    ...
    <section class="flex-center page-top-banner"><img alt="MAXIMUS PLATFORM" class="mex-img-cover" data-entity-type="" data-entity-uuid="" src="/multibankfx/public_files/images/platforms/maximus/img_topbanner1.jpg" />
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-12">
                    <h1 class="mex-h1 text-fff text-left"><?php translate('MAXIMUS PLATFORM'); ?></h1>
                    <div class="mex-content text-fff mex-m-b-30">
                        <p class="mex-m-t-15 mex-m-b-15"><?php translate('This MT4 trading platform is ideal for Introducing Brokers and traders who seek no-frill trading experience.'); ?></p>
                        <p class="mex-m-t-15 mex-m-b-15"><?php translate('The Maximus platform requires minimal investment commitment and is ideal for traders who want to use EA'); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-12">
                        <div class="container">
                            <div class="mex-h1 text-fff text-center uppercase mex-p-b-40"><?php translate('PLATFORM ADVANTAGES'); ?></div>
                        </div>
                    </div>
                            ...
                            <div class="book-content-inner ">
                                <div class="col-md-12">
                                    <ul class="mex-list-conditions new-product">
                                        <li><?php translate('Access to the most liquid market in the world');?></li>
                                        <li><?php translate('24 hours instant and stable nano-second execution'); ?></li>
                                        <li><?php translate('Leverage up to 500:1'); ?></li>
                                        <li><?php translate('Over 45 forex pairs available'); ?></li>
                                        <li><?php translate('Up to 5 levels of Market Depth'); ?></li>
                                        ...
                                        <li><?php translate('Award-winning MT4 platforms recognized for excellence in technology and liquidity'); ?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="table-incomplete table-responsive security-of-funds-table">
                        <table class="fx-spread-table table mex-table mex-has-type table-striped-blue">
                            <thead>
                                <tr>
                                    <th class="mex-translatable" data-es="Pares de monedas" data-de="Währungspaare" data-ph="" data-vn="Cặp tiền tệ" data-id="Pasangan mata uang" data-pt="Pares de moedas" data-ru="Валютные пары" data-it="Coppia di valute" data-fr="Paires de devises" data-mys="Pasangan matawang" data-th="คู่สกุลเงิน" data-ae="أزواج العملات"><?php translate('Currency Pairs');?>
                    ...
                    <div class="mex-m-b-30 text-center">
                        <div class=" mex-m-b-20">
                            <ul id="myTab" class="icon-nav">
                                ...
                                <li class="platform-selector-container "><img src="/multibankfx/public_files/images/common/ic_mt5.png" alt="MT5"><br><a class="platform-selector uppercase" data-tab="tab_mt5">MT5</a></li>
                            </ul>
                        </div>
                        <div>
                                    ...
                                    <div class="col-xs-12 col-md-12 p0 d-flex justify-content-center flex-wrap">
                                        <div class="platform-box">
                                            ...
                                            <div class="platform-icon">
                                                ...
                                                <a href="/multibankfx/web/uploads/democomp/metatrader4.apk" target="_blank"><img src="/multibankfx/public_files/images/common/ic_android.svg" alt="android"></a>
                                            </div>
                                        </div>
                                        <div class="platform-box">
                                            ...
                                            <div class="platform-icon">
                                                <a href="/multibankfx/web/uploads/democomp/demo/ecnmexintgroup4setup.exe" target="_blank"><img src="/multibankfx/public_files/images/common/windows.png" alt="window"></a>
                                            </div>
                                        </div>
                                        <div class="platform-box">
                                            ...
                                            <div class="platform-icon">
                                                <a href="/multibankfx/mql5.php" target="_blank"><img src="/multibankfx/public_files/images/common/chrome.png" alt="chrome"></a>
                                                <a href="/multibankfx/mql5.php" target="_blank"><img src="/multibankfx/public_files/images/common/firefox.png" alt="firefox"></a>
                                                <a href="/multibankfx/mql5.php" target="_blank"><img src="/multibankfx/public_files/images/common/ic_ie@2x.png" alt="IE"></a>
                                                <a href="/multibankfx/mql5.php" target="_blank"><img src="/multibankfx/public_files/images/common/safari.png" alt="safari"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-platform active" id="tab_maximus">
                                    <div class="col-xs-12 col-md-12 p0 d-flex justify-content-center flex-wrap">
                                        ...
                                        <div class="platform-box">
                                            ...
                                            <div class="platform-icon">
                                                <a href="/multibankfx/web/uploads/democomp/demo/maximusmexintgroup4setup.exe" target="_blank"><img src="/multibankfx/public_files/images/common/windows.png" alt="window"></a>
                                            </div>
                                        </div>
                                        <div class="platform-box">
                                            <div class="platform-name text-center mex-translatable" data-es="Web de comercio" data-de="Web-Trading" data-ph="" data-vn="" data-id="Perdagangan Web" data-pt="Negociação na Web" data-ru="Веб-трейдинг" data-it="" data-fr="" data-mys="Perdagangan Web" data-th="เว็บเทรดดิ้ง" data-ae="منصة الويب"><?php translate('Web Trading'); ?>
                                ...
                                <div class="tab-platform" id="tab_multibank_pro">
                                    <div class="col-xs-12 col-md-12 p0 d-flex justify-content-center flex-wrap">
                                        ...
                                        <div class="platform-box">
                                            ...
                                            <div class="platform-icon">
                                                <a href="/multibankfx/web/uploads/democomp/demo/promexintgroup4setup.exe" target="_blank"><img src="/multibankfx/public_files/images/common/windows.png" alt="windows"></a>
                                            </div>
                                        </div>
                                        <div class="platform-box">
                                            <div class="platform-name text-center mex-translatable" data-es="Web de comercio" data-de="Web-Trading" data-ph="" data-vn="" data-id="Perdagangan Web" data-pt="Negociação na Web" data-ru="Веб-трейдинг" data-it="" data-fr="" data-mys="Perdagangan Web" data-th="เว็บเทรดดิ้ง" data-ae="منصة الويب"><?php translate('Web Trading'); ?>
    ...
    <section class="bg-gray platforms choose-next-background square">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h2 class="mex-h1 text-center mex-m-b-40 uppercase text-1e32a3 mex-translatable" data-es="Comparativa plataformas MT4" data-de="MT4 PLATTFORM VERGLEICH" data-ph="" data-vn="" data-id="" data-pt="COMPARAÇÃO DE PLATAFORMAS MT4" data-ru="Сравнение платформ MT4" data-it="CONFRONTO DELLE PIATTAFORME MT4" data-fr="Comparaison des plateformes MT4" data-mys="Perbandingan Platform MT4:" data-th="เปรียบเทียบแพลตฟอร์มของ MT4" data-ae="مقارنة المنصات"><?php translate('MT4 Platform Comparison'); ?></h2>
                    <div class="table-responsive">
                        <table class="fx-spread-table table mex-table mex-has-type table-striped-blue">
                            ...
                            <tbody>
                                <tr>
                                    <td style="position: sticky;"><b class="mex-translatable" data-es="Spread Medio" data-de="Durchschnittliche Spreads" data-ph="" data-vn="Spreads Trung Bình" data-id="" data-pt="Spreads médios" data-ru="Средние спреды" data-it="Spread medi" data-fr="Spreads Moyens" data-mys="Spread Purata" data-th="สเปรดเฉลี่ย" data-ae="متوسط السبريد"><?php translate('Average Spreads'); ?></b>
                                        <div class="border-right-blue"></div>
                                    </td>
                                ...
                                <tr>
                                    <td style="position: sticky;"><b class="mex-translatable" data-es="" data-de="" data-ph="" data-vn="" data-id="" data-pt="" data-ru="" data-it="" data-fr="" data-th="" data-mys="" data-ae=""><?php translate('Bonus Promotions');?></b>
                                        <div class="border-right-blue" style="position:absolute;border:1px solid #818CCB; height:80%;right:0;top:10%"></div>
                                    </td>
...
بونص إحالة صديق">100% Bonus<br />25% Bonus<br />Imperial Bonus<br />Refer a Friend Bonuss</td>
            ...
            <div class="col-md-12">
                ...
                <div class="icon-next-list">
                    <ul class="bg-white target-icon">
                        <li><a href="compare-platforms.php"><span class="ico-ic_compare_our_trading_platforms"></span> </a>
                            <div class="mex-content mex-clamp-3"><a href="compare-platforms.php">Compare our Trading Platforms</a></div>
                            <a href="compare-platforms.php"> </a>
                        </li>
                        ...
                        <li><a href="download-center.php"><span class="ico-ic_download_mt4"></span> </a>
                            <div class="mex-content mex-clamp-3"><a href="download-center.php">Download MT4</a></div>
                            <a href="download-center.php"> </a>
                        </li>
                        ...
                        <li><a href="/multibankfx/mfx/v1/about/regulations.php"><span class="ico-ic_our_regulations"></span> </a>
                            <div class="mex-content mex-clamp-3"><a href="/multibankfx/mfx/v1/about/regulations.php">Our Regulations</a></div>
                        ...
                        <li><a href="/multibankfx/index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-cb3b632552f13428c673980c-=""><span class="ico-ic_live_chat_support"></span> </a>
                            <div class="mex-content mex-clamp-3"><a href="/multibankfx/index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-cb3b632552f13428c673980c-="">Live Chat Support</a></div>
                            <a href="/multibankfx/index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-cb3b632552f13428c673980c-=""> </a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="slidebar">
        ...
        <a class="email-us-tg demo-account-btn email-btn" href="/multibankfx/cdn-cgi/l/email-protection.html#701303301d051c041912111e1b16085e131f1d">
    ...
    <script src="/multibankfx/public_files/static_js/lang_data/en.js" type="cb3b632552f13428c673980c-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.dataTables.min.js" type="cb3b632552f13428c673980c-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/lazysizes.min.js" type="cb3b632552f13428c673980c-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.validate.min.js" type="cb3b632552f13428c673980c-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/intlTelInput.min.js" type="cb3b632552f13428c673980c-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/app.js" type="cb3b632552f13428c673980c-text/javascript"></script>
