...
<body>
    ...
    <section class="mex-block-h600 flex-center">
        <img alt="MultiBank Web Trader" class="mex-img-cover" data-entity-type="" data-entity-uuid="" src="/multibankfx/public_files/images/platforms/download_center/download_center_web_trader_banner.jpg" />
        <div class="container">
            <div class="row">
                <div class="col-sm-10 col-md-8 col-xl-6 col-10 mex-content">
                    <div class="mex-h1 text-1e32a3 text-left"><?php translate('MultiBank Web Trader'); ?></div>
                    <p class="mex-m-t-30"><?php translate('Trade on our web platform optimized with high performance and speedy
                        execution.'); ?></p>
                    <p class="mex-m-t-30"><?php translate('MultiBank Web Trader allow you to trade our full suite of products from any
                        browser and operating system with the click of a button. Access your account and start trading
                        now!'); ?></p>
                    <div class="mex-h3 mex-m-b-30 mex-m-t-30"><?php translate('Features:'); ?></div>
                    <ul class="mex-list-icon-check">
                        <li><?php translate('Trade directly online- no need to download software!'); ?></li>
                        <li><?php translate('Compatible with all operating systems'); ?></li>
                        <li><?php translate('Fully secure and encrypted application'); ?></li>
                        <li><?php translate('Access advanced trading tools, 24-hour market news, technical and fundamental analysis,
                            economic calendar'); ?></li>
                        <li><?php translate('Advanced charting features, with wide range of technical indicators and drawing tools'); ?></li>
                    ...
                    <div class="browser-list"><a href="/multibankfx/mql5.php"><img alt="Google" class="mex-m-b-10" data-entity-type="" data-entity-uuid="" src="/multibankfx/public_files/images/common/chrome.png" /> </a> <a href="/multibankfx/mql5.php"> <img alt="O" class="mex-m-b-10 browser-list-img" data-entity-type="" data-entity-uuid="" src="/multibankfx/public_files/images/common/oprea.png" /> </a> <a href="/multibankfx/mql5.php"> <img alt="Firefox" class="mex-m-b-10 browser-list-img" data-entity-type="" data-entity-uuid="" src="/multibankfx/public_files/images/common/firefox.png" /> </a> <a href="/multibankfx/mql5.php"> <img alt="Safari" class="mex-m-b-10 browser-list-img" data-entity-type="" data-entity-uuid="" src="/multibankfx/public_files/images/common/safari.png" /> </a></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="slidebar">
        ...
        <a class="email-us-tg demo-account-btn email-btn" href="/multibankfx/cdn-cgi/l/email-protection.html#016272416c746d756863606f6a67792f626e6c">
    ...
    <script src="/multibankfx/public_files/static_js/lang_data/en.js" type="9ca329a262d339b1caf83797-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.dataTables.min.js" type="9ca329a262d339b1caf83797-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/lazysizes.min.js" type="9ca329a262d339b1caf83797-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.validate.min.js" type="9ca329a262d339b1caf83797-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/intlTelInput.min.js" type="9ca329a262d339b1caf83797-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/app.js" type="9ca329a262d339b1caf83797-text/javascript"></script>
