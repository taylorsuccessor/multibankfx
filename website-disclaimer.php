...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <h1 class="mex-h1 text-1e32a3 mex-m-b-40 text-center"><?php translate('Disclaimer'); ?></h1>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('By using this website and or its services, you agree that neither MultiBank Group nor any of its affiliates and service providers will be held responsible for the accuracy of any information available on this site. Although information on this site is provided in good faith and is believed by MultiBank Group or its affiliates to be accurate, there are no explicit or implicit warranties of accuracy or timeliness made by MultiBank Group or its affiliates and service providers regarding this information. Furthermore, in visiting this site and in opening an MultiBank Group or its affiliates Forex trading account you agree not to hold MultiBank Group or any of its affiliates and service providers liable for any decisions you may make based on the information you obtain on this website or websites we link to. It is recommended that you make your decisions only after you have reviewed information and collected opinions from several credible sources and have verified ALL facts you need to know about Forex trading from other independent sources.'); ?></p>
                        <p class="mex-m-b-30"><?php translate('MultiBank Group and its web hosting providers and its affiliates shall in no event be liable for any damages and or loss resulting from interruption of website service or the inability to use our website.'); ?></p>
                        <p class="mex-m-b-30"><?php translate('Unless stated otherwise, material on this site is copyright of MultiBank Group. MultibankFX is the trading name of Multibank FX International Corporation (BVI) Company No. 1377324.'); ?></p>
                        <h2 class="mex-h1 text-1e32a3 mex-m-b-40 text-center"><?php translate('Phishing Sites'); ?></h2>
                        <p class="mex-m-b-30"><?php translate('It has been brought to our attention, that there has been numerous fraudulent activities operating in regards to mimicking our company, phishing sites, and alike on the internet.'); ?></p>
                        <p class="mex-m-b-30"><?php translate('Therefore, we strongly advise that you do not disclose any account or password information to sites that do not cohere with the domain:'); ?> <a href="cdn-cgi/l/email-protection.html#a2c1d1e2cfd7ced6cbc0c3ccc9c4da8cc1cdcfc1d1e2cfd7ced6cbc0c3ccc9c4da8cc1cdcf" class="c731">www.multibankfx.com</a></p>
                        <p class="mex-m-b-30"><?php translate('Please be vigilant.'); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="16a53aafd67701a1d853ee3a-|49" defer=""></script>
</body>
