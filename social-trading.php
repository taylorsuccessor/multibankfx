...
<body>
    ...
    <section class="page-top-banner p-0">
        ...
        <div class="st-banner-text-container">
            <div>
                ...
                <div class="slider-icons">
                    <div class="slider-icon"><a href="social-trading/trader.html"><img src="public_files/images/social_trading/icon_investor.png"><br />TRADER >></a></div>
                    <div class="slider-icon"><a href="social-trading/investor.html"><img src="public_files/images/social_trading/icon_signal_provider.png"><br />INVESTOR >></a>
                    </div>
                    <div class="slider-icon"><a href="social-trading/faq.html"><img src="public_files/images/social_trading/icon_faq.png"><br />FAQ >></a></div>
                    <div class="slider-icon"><a href="social-trading/leaderboard.html"><img src="public_files/images/social_trading/icon_leader_board.png"><br />LEADERBOARD >></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="st-banner-btn-container">
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-12">
                <a href="social-trading/leaderboard.html" class="btn-st-red btn-banner transparent text-fff">Leaderboard</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row mex-m-x-80">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="row mx-0"><a href="social-trading/trader.html" class="btn-st-1ba6df ml-0 text-fff">Become A Signal Provider</a></div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-6 col-xl-8">
                    ...
                    <div class="row mx-0"><a href="social-trading/investor.html" class="btn-st-006AD0 text-fff ml-0">Become An Investor</a></div>
                </div>
    ...
    <section class="st-section">
        ...
        <div class="container text-center">
            ...
            <div class="">Check out our <a href="social-trading/faq.html" class="text-005190">FAQ</a> or <a class="text-005190">Request</a> a Call Back Now!</div>
        </div>
    </section>
    <style>
        .btn-banner {
