...
<body>
    ...
    <div class="main-container">
        <div class="main-container">
            <section class="table-background plants">
                <h1 class="mex-h1 text-center mex-m-b-40">MEX EXCHANGE</h1>
                <div class="container">
                    <div class="row withdrawals-tabs">
                        <ul class="mex-tabs mex-m-b-15" style="padding:0;">
                            <li class="tab-title" style="width: 17%;"><a href="funds-deposit-mex-australia-ltd.html#aw_usd">USD</a></li>
                            <li class="tab-title" style="width: 17%;"><a href="funds-deposit-mex-australia-ltd.html#aw_eur">EUR</a></li>
                            <li class="tab-title" style="width: 16%;"><a href="funds-deposit-mex-australia-ltd.html#aw_aud">AUD</a></li>
                            <li class="tab-title" style="width: 17%;"><a href="funds-deposit-mex-australia-ltd.html#aw_gbp">GBP</a></li>
                            <li class="tab-title" style="width: 16%;"><a href="funds-deposit-mex-australia-ltd.html#aw_hkd">HKD</a></li>
                            <li class="tab-title" style="width: 17%;"><a href="funds-deposit-mex-australia-ltd.html#aw_cad">CAD</a></li>
                        </ul>
                        <div class="tab-content" style="width:100%;">
                            <div class="tab-pane" id="aw_usd">
                                <div class="table-responsive">
                                    <table class="table mex-table">
                                        <thead>
                                            <tr>
                                                <th colspan="2">Deposit in USD of National Australia Bank Account</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>National Australia Bank House, 255 George St., Sydney, NSW 2000, Australia</td>
                                            </tr>
                                            <tr>
                                                <td>SWIFT</td>
                                                <td>NATAAU3302S</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>Suite 5, Level 22, 227 Elizabeth Street, SYDNEY 2000, Australia</td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="tab-pane" id="aw_eur">
                                <div class="table-responsive">
                                    <table class="table mex-table">
                                        <thead>
                                            <tr>
                                                <th colspan="2">Deposit in EUR of National Australia Bank Account</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                            ...
                            <div class="tab-pane" id="aw_aud">
                                <div class="table-responsive">
                                    <table class="table mex-table">
                                        <thead>
                                            <tr>
                                                <th colspan="2">Deposit in AUD of National Australia Bank Account</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                            ...
                            <div class="tab-pane" id="aw_gbp">
                                <div class="table-responsive">
                                    <table class="table mex-table">
                                        <thead>
                                            <tr>
                                                <th colspan="2">Deposit in GBP of National Australia Bank Account</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                            ...
                            <div class="tab-pane" id="aw_hkd">
                                <div class="table-responsive">
                                    <table class="table mex-table">
                                        <thead>
                                            <tr>
                                                <th colspan="2">Deposit in HKD of National Australia Bank Account</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                            ...
                            <div class="tab-pane" id="aw_cad">
                                <div class="table-responsive">
                                    <table class="table mex-table">
                                        <thead>
                                            <tr>
                                                <th colspan="2">Deposit in CAD of National Australia Bank Account</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
        ...
        <script type="b8390eeaad8102fc4ea19d4d-text/javascript">
            $(function() {
                $('.mex-tabs li:eq(0)').addClass('active');
                $('#aw_usd').removeClass('fade').show('fast');
                ...
                $('.mex-tabs a').click(function(e) {
                    ...
                    $('#aw_usd').addClass('fade').hide();
                    $('#aw_eur').addClass('fade').hide();
                    $('#aw_aud').addClass('fade').hide();
                    $('#aw_gbp').addClass('fade').hide();
                    $('#aw_hkd').addClass('fade').hide();
                    $('#aw_cad').addClass('fade').hide();
                ...
                <div class="col-md-12">
                    ...
                    <div class="icon-next-list">
                        <ul class="bg-white target-icon">
                            ...
                            <li><a href="/multibankfx/index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-b8390eeaad8102fc4ea19d4d-=""><span class="ico-ic_live_chat_support"></span> </a>
                                <div class="mex-content mex-clamp-3"><a href="/multibankfx/index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-b8390eeaad8102fc4ea19d4d-="">Live Chat Support</a></div>
                                <a href="/multibankfx/index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-b8390eeaad8102fc4ea19d4d-=""> </a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="cc-country-selector">
        <div class="cc-country-selector--overlay" onclick="if (!window.__cfRLUnblockHandlers) return false; closeCountrySelectionDialog()" data-cf-modified-b8390eeaad8102fc4ea19d4d-=""></div>
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-7 mx-auto cc-country-selector--box">
                    ...
                    <button type="button" class="cc-country-selector--submit--btn" onclick="if (!window.__cfRLUnblockHandlers) return false; redirectCreditCard()" data-cf-modified-b8390eeaad8102fc4ea19d4d-="">Submit</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="slidebar">
        ...
        <a class="ib-registration-btn chat-btn" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-b8390eeaad8102fc4ea19d4d-="">
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1Njo1MA==' />
                    <input type='hidden' name='token' value='$2y$10$zTV7FG7OF7oJuPgxZZuUzOcXbbkcvirUBuvablYxFYiLXW/XItvF.' />
                    <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:56:24] https://www.multibankfx.com/social-trading<br/><br/>[2020-06-27 02:56:25] https://www.multibankfx.com/social-trading<br/><br/>[2020-06-27 02:56:27] https://www.multibankfx.com/social-trading<br/><br/>[2020-06-27 02:56:50] https://www.multibankfx.com/account/account-funding<br/><br/> <br/><br/> posted From: www.multibankfx.com/open-forex-account/funds-deposit-mex-australia-ltd?web=true' />
                    ...
                    </div><button type='submit' class='btn btn-mex ml-auto btn-submit' onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-b8390eeaad8102fc4ea19d4d-="">SEND</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script src="/multibankfx/public_files/static_js/lang_data/en.js" type="b8390eeaad8102fc4ea19d4d-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.dataTables.min.js" type="b8390eeaad8102fc4ea19d4d-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/lazysizes.min.js" type="b8390eeaad8102fc4ea19d4d-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.validate.min.js" type="b8390eeaad8102fc4ea19d4d-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/intlTelInput.min.js" type="b8390eeaad8102fc4ea19d4d-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/app.js" type="b8390eeaad8102fc4ea19d4d-text/javascript"></script>
    <script type="b8390eeaad8102fc4ea19d4d-text/javascript" async>
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="b8390eeaad8102fc4ea19d4d-|49" defer=""></script>
</body>
