...
<body>
    ...
    <div class="main-container">
        <div class="main-container">
            <section class="table-background plants">
                <h1 class="mex-h1 text-center mex-m-t-50 mex-m-b-40">MULTIBANK FX INTERNATIONAL</h1>
                <div class="container">
                    <div class="row withdrawals-tabs">
                        <ul class="mex-tabs  mex-m-b-15" style="padding:0;">
                            <li class="tab-title col-xs-6" style="width: 16.66%"><a href="funds-deposit-multibank-fx-ltd.html#aw_fdmcl_usd_international">USD</a></li>
                            <li class="tab-title col-xs-6 p0" style="width: 16.66%"><a href="funds-deposit-multibank-fx-ltd.html#aw_fdmcl_eur_international">EUR</a></li>
                            <li class="tab-title col-xs-6 p0" style="width: 16.66%"><a href="funds-deposit-multibank-fx-ltd.html#aw_fdmcl_gbp_international">GBP</a></li>
                            <li class="tab-title col-xs-6 p0" style="width: 16.66%"><a href="funds-deposit-multibank-fx-ltd.html#aw_fdmcl_hkd_international">HKD</a></li>
                            <li class="tab-title col-xs-6 p0" style="width: 16.66%"><a href="funds-deposit-multibank-fx-ltd.html#aw_fdmcl_aud_international">AUD</a></li>
                            <li class="tab-title col-xs-6 p0" style="width: 16.66%"><a href="funds-deposit-multibank-fx-ltd.html#aw_fdmcl_nzd_international">NZD</a></li>
                        </ul>
                        <div class="tab-content" style="width:100%;">
                            <div class="tab-pane" id="aw_fdmcl_usd_international" role="tabpanel">
                                <div class="table-responsive">
                                    <table class="table mex-table">
                                        <thead>
                                            <tr>
                                                <th colspan="2">USD Deposit</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>111 W Monroe St, Chicago, Illinois, 60603, USA</td>
                                            </tr>
                                            <tr>
                                                <td>SWIFT</td>
                                                <td>HATRUS44</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>MultiBank FX International Corporation</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>Craigmuir Chambers, Road Town, Tortola VG1110, British Virgin Islands</td>
                                            </tr>
                                            <tr>
                                                <td>Payment Details</td>
                                                <td>For account of (your name)</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                            <div class="tab-pane" id="aw_fdmcl_eur_international" role="tabpanel">
                                <div class="table-responsive">
                                    <table class="table mex-table">
                                        <thead>
                                            <tr>
                                                <th colspan="2">EUR Deposit</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>Beneficiary Bank Address</td>
                                                <td>111 W Monroe St, Chicago, IL, 60603, USA</td>
                                            </tr>
                                            <tr>
                                                <td>SWIFT</td>
                                                <td>HATRUS44GTM</td>
                            ...
                            <div class="tab-pane" id="aw_fdmcl_gbp_international" role="tabpanel">
                                <div class="table-responsive">
                                    <table class="table mex-table">
                                        <thead>
                                            <tr>
                                                <th colspan="2">GBP Deposit</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>Intermediary Bank Name</td>
                                                <td>ROYAL BANK OF SCOTLAND - LONDON</td>
                                            </tr>
                                            <tr>
                                                <td>Intermediary Bank SWIFT</td>
                                                <td>NWBKGB2L</td>
                            ...
                            <div class="tab-pane" id="aw_fdmcl_hkd_international" role="tabpanel">
                                <div class="table-responsive">
                                    <table class="table mex-table">
                                        <thead>
                                            <tr>
                                                <th colspan="2">HKD Deposit</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                            ...
                            <div class="tab-pane" id="aw_fdmcl_aud_international" role="tabpanel">
                                <div class="table-responsive">
                                    <table class="table mex-table">
                                        <thead>
                                            <tr>
                                                <th colspan="2">AUD Deposit</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>Intermediary Bank Name</td>
                                                <td>COMMONWEALTH BANK OF AUSTRALIA - SYDNEY</td>
                                            </tr>
                                            <tr>
                                                <td>Intermediary Bank SWIFT</td>
                                                <td>CTBAAU2S</td>
                            ...
                            <div class="tab-pane" id="aw_fdmcl_nzd_international" role="tabpanel">
                                <div class="table-responsive">
                                    <table class="table mex-table">
                                        <thead>
                                            <tr>
                                                <th colspan="2">NZD Deposit</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
        ...
        <script type="17e92fec473d396ef3d49432-text/javascript">
            $(function() {
                $('.mex-tabs li:eq(0)').addClass('active');
                $('#aw_fdmcl_usd_international').removeClass('fade').show('fast');
                $('.mex-tabs a').click(function(e) {
                    e.preventDefault();
                    $('.mex-tabs li:eq(0)').removeClass('active');
                    $('.mex-tabs li:eq(1)').removeClass('active');
                    $('.mex-tabs li:eq(2)').removeClass('active');
                    $('.mex-tabs li:eq(3)').removeClass('active');
                    $('.mex-tabs li:eq(4)').removeClass('active');
                    $('.mex-tabs li:eq(5)').removeClass('active');
                    $('#aw_fdmcl_usd_international').addClass('fade').hide();
                    $('#aw_fdmcl_eur_international').addClass('fade').hide();
                    $('#aw_fdmcl_hkd_international').addClass('fade').hide();
                    $('#aw_fdmcl_gbp_international').addClass('fade').hide();
                    $('#aw_fdmcl_aud_international').addClass('fade').hide();
                    $('#aw_fdmcl_nzd_international').addClass('fade').hide();
                    $(this).parent().addClass('active');
                    $(this.hash).removeClass('fade').show('fast');
                });
            });
        </script>
                    ...
                    <div class="icon-next-list">
                        <ul class="bg-white target-icon">
                            <li><a href="/multibankfx/platforms/download-center.php"><span class="ico-ic_download_mt4"></span> </a>
                                <div class="mex-content mex-clamp-3"><a href="/multibankfx/platforms/download-center.php">Download MT4</a></div>
                            ...
                            <li><a href="/multibankfx/index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-17e92fec473d396ef3d49432-=""><span class="ico-ic_live_chat_support"></span> </a>
                                <div class="mex-content mex-clamp-3"><a href="/multibankfx/index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-17e92fec473d396ef3d49432-="">Live Chat Support</a></div>
                                <a href="/multibankfx/index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-17e92fec473d396ef3d49432-=""> </a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="cc-country-selector">
        <div class="cc-country-selector--overlay" onclick="if (!window.__cfRLUnblockHandlers) return false; closeCountrySelectionDialog()" data-cf-modified-17e92fec473d396ef3d49432-=""></div>
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-7 mx-auto cc-country-selector--box">
                    ...
                    <button type="button" class="cc-country-selector--submit--btn" onclick="if (!window.__cfRLUnblockHandlers) return false; redirectCreditCard()" data-cf-modified-17e92fec473d396ef3d49432-="">Submit</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="slidebar">
        ...
        <a class="email-us-tg demo-account-btn email-btn" href="/multibankfx/cdn-cgi/l/email-protection.html#85e6f6c5e8f0e9f1ece7e4ebeee3fdabe6eae8">
        ...
        <a class="ib-registration-btn chat-btn" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-17e92fec473d396ef3d49432-="">
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1Njo1NQ==' />
                    <input type='hidden' name='token' value='$2y$10$S7qd0LHik0inOMJgRDRfRO1.7XmFHDwXaQZ3aqKQrUzqNDMZw.N3W' />
                    <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:56:50] https://www.multibankfx.com/account/account-funding<br/><br/>[2020-06-27 02:56:53] https://www.multibankfx.com/account/account-funding<br/><br/>[2020-06-27 02:56:54] https://www.multibankfx.com/account/account-funding<br/><br/>[2020-06-27 02:56:55] https://www.multibankfx.com/account/account-funding<br/><br/> <br/><br/> posted From: www.multibankfx.com/open-forex-account/funds-deposit-multibank-fx-ltd?web=true' />
                    ...
                    </div><button type='submit' class='btn btn-mex ml-auto btn-submit' onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-17e92fec473d396ef3d49432-="">SEND</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script src="/multibankfx/public_files/static_js/lang_data/en.js" type="17e92fec473d396ef3d49432-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.dataTables.min.js" type="17e92fec473d396ef3d49432-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/lazysizes.min.js" type="17e92fec473d396ef3d49432-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.validate.min.js" type="17e92fec473d396ef3d49432-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/intlTelInput.min.js" type="17e92fec473d396ef3d49432-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/app.js" type="17e92fec473d396ef3d49432-text/javascript"></script>
    <script type="17e92fec473d396ef3d49432-text/javascript" async>
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="17e92fec473d396ef3d49432-|49" defer=""></script>
</body>
