...
<body>
        ...
        <div class="container">
            <div class="row flex-box">
                <div class="col-sm-12 col-md-6 col-lg-6 mb-s-30">
                    <section class="mex-block-card-v tools-mex-block-card-v">
                        <div class="card-img-box">
                            <img class="mex-img-cover" src="/multibankfx/public_files/images/tools/bn_vps@2x.png" alt="Account Base Currencies">
                        </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 mb-s-30">
                    <section class="mex-block-card-v tools-mex-block-card-v">
                        <div class="card-img-box">
                            <img class="mex-img-cover" src="/multibankfx/public_files/images/tools/bn_multibank@2x.png" alt="Margin">
                        </div>
                        <div class=" card-content bg-white text-left">
                            <div class="mex-h2 uppercase">
                                MARGIN
    ...
    <section class="mex-block-h600 flex-center"><img src="/multibankfx/public_files/images/tools/trading_conditions_submit_a_vps_request@2x.jpg" alt="Stop-out Level" class="mex-img-cover" />
        <div class="container">
            <div class="row">
    ...
    <script src="/multibankfx/public_files/static_js/lang_data/en.js" type="7e744ff7d61fda2bbefd399a-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.dataTables.min.js" type="7e744ff7d61fda2bbefd399a-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/lazysizes.min.js" type="7e744ff7d61fda2bbefd399a-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.validate.min.js" type="7e744ff7d61fda2bbefd399a-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/intlTelInput.min.js" type="7e744ff7d61fda2bbefd399a-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/app.js" type="7e744ff7d61fda2bbefd399a-text/javascript"></script>
