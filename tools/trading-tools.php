        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-12 mx-auto shadow-box bg-white">
                    ...
                    <div class="px-1 " style="padding:15px 0px;">
                        <div class="form-check form-check-inline">
                            <label class="form-check-label label-1 " for="terms_conditions"><?php translate('By submitting this form, you agree to accept the'); ?> <a href="../terms-conditions.html" target="_blank" class="text-22A0C4" style="padding:0 !important;"><?php translate('Terms & Conditions'); ?></a>, <a href="../privacy-policy.html" target="_blank" class="text-22A0C4" style="padding:0 !important;">Privacy Policy</a>, <?php translate('and'); ?> <a href="../cookie-policy.html" target="_blank" class="text-22A0C4" style="padding:0 !important;"><?php translate('Cookie Policy'); ?></a>.
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="icon-next-list">
                    <ul class="bg-white target-icon">
                        ...
                        <li><a href="../account.html"><span class="ico-ic_accounts_funding"></span> </a>
                            <div class="mex-content mex-clamp-3"><a href="../account.html"><?php translate('Accounts and Funding '); ?></a></div>
