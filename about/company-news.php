...
<head>
    ...
    <meta property='og:description'
          content="Keep up to date with MultiBank's latest news. MultiBank Group expands across Europe making it one of the latest financial derivatives companies worldwide.">
    <link rel='canonical' href="article/news_20180916.php">
    ...
    <link rel="alternate" href="article/news_20180916.php" hreflang="x-default"/>
            ...
            <div class="col-12 col-lg-3">
                <div class="border-form mex-p-h-15 mb-4 mex-m-t-40 bg-white">
                    <form action="https://www.multibankfx.com/form/contactus?" name='contact_us_form'
                        ...
                        <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo0OToxNg=='/>
                        <input type='hidden' name='token'
                               value='$2y$10$BPTD9CUISCZY3gJI.ug8zusYGRdX.Ektu0lwnkQVikA/Kervd2b6O'/>
                        <input type='hidden' name='source'
                               value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:13] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:14] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:15] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:16] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/about/company-news?web=true'/>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-12 row ">
                <div class="border-line col-md-6 col-lg-4 col-sm-12 col-xs-12 hidden-md">
                    ...
                    <a class="btn btn-mex " href="contact.php">Find your Country here</a></div>
                ...
                <div class="col-md-6 col-lg-4 col-sm-12 col-xs-12 d-none d-md-block">
                    ...
                    <div style="width: 100%;">
                        <form action="https://www.multibankfx.com/form/callback?" name='call_back_footer_form'
                            ...
                            <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo0OToxNg=='/>
                            <input type='hidden' name='token'
                                   value='$2y$10$9M6ilPNLaRLeRoL1vLJ57.3QSM4u.e5agyJ0kr5iQJrt/pmpe8f8W'/>
                            <input type='hidden' name='source'
                                   value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:13] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:14] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:15] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:16] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/about/company-news?web=true'/>
                            <div class='mex-form-item col-6 p-1 cb-partnership font-16 text-center'>
                                <label for='' class='m-0'>
                            ...
                            <button type='submit' class='btn btn-mex mx-auto'
                                    onsubmit="if (!window.__cfRLUnblockHandlers) return false; "
                                    data-cf-modified-add9bdeab49ae9424dd66d41-="">CALL ME
                            </button>
                        </form>
                        <div class="px-1 font-10" style="padding:0px;">
                            <div class="form-check form-check-inline">
        ...
        <div class="col-lg-12 footer">
            <div class="row justify-content-between" style="padding-bottom: 25px; border-bottom: 1px solid #808080;">
                <div class="col-xs-12 col-sm-12 col-md-8 footer_other_left align-self-center">
                    ...
                    <a href="article/hiring-now-cyprus.php" target="_parent">Career</a>
            ...
            <div class="footer_map_content d-none d-md-block" style="margin-top: 0; border-top: none">
                <div class="row">
                    <div class="col-md-2">
                        <ul class="footer_map">
                            <li><a href="about.php"><strong>About us</strong></a> <a href="why-multibank-group.php"
                                                                                         target="_parent">Why
                                Multibank</a> <a href="global-presence.php" target="_parent">Global Presence</a> <a
                                    href="mfx/v1/about/regulations.php" target="_parent">Regulations</a> <a
                                ...
                                <a href="article/news_20180916.php" target="_parent">Company News</a> <a
                                        href="article/hiring-now-cyprus.php" target="_parent">Career</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-2">
                        <ul class="footer_map">
                            <li><a href="products.php"><strong>Products</strong></a> <a
                                    href="products/forex.php" target="_parent">Forex</a> <a
                                    href="products/metals.php" target="_parent">Metals</a> <a
                                    href="products/shares.php" target="_parent">Shares</a>
                                <a href="products/indices.php" target="_parent">Indices</a> <a
                                        href="products/commodities.php" target="_parent">Commodities</a>
                    ...
                    <div class="col-md-2">
                        <ul class="footer_map">
                            <li><a href="account.php"><strong>Accounts &amp; Funding</strong></a> <a
                                    ...
                                    href="account/account-forms.php" target="_parent">Account Forms </a> <a
                                    href="account/bonus.php" target="_parent">Bonuses</a></li>
                        </ul>
                    </div>
                    <div class="col-md-2">
                        <ul class="footer_map">
                            <li><a href="tools.php"><strong>Tools</strong></a> <a href="tools/trading-tools.php"
                                                                                      target="_parent">Trading
                                Tools </a> <a href="tools/trading-conditions.php" target="_parent">Trading
                                Conditions </a> <a href="tools/holiday-hours-notices.php" target="_parent">Trading
                                Hours &amp; Holiday
                                Notice </a> <a href="cfd-expiration-dates.php" target="_parent">CFD Expiration
                                Dates</a>
                    ...
                    <div class="col-md-2">
                        <ul class="footer_map">
                            <li><a href="investor-relations.php"><strong>Partnership</strong></a> <a
                                    href="partnership/introducing-brokers.php" target="_parent">Introducing
                                Brokers </a> <a href="partnership/franchise-program.php" target="_parent">Franchise
                                Program </a> <a href="partnership/white-label.php" target="_parent">White Label </a>
                                <a href="partnership/prime-of-primes.php" target="_parent">Prime of Primes</a> <a
                                        href="partnership/cpa-affiliate-program.php" target="_parent">CPA Affiliate
                                    Program</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="footer_pa">
                ...
                <p><a href="privacy-policy.php" target="_parent">Privacy Policy </a> | <a
                        href="cookie-policy.php" target="_parent"> Cookie
                    Policy</a> | <a href="terms-conditions.php" target="_parent">Terms &amp; Conditions </a> | <a
                        href="website-disclaimer.php" target="_parent"> Website Disclaimer </a> | <a
                        href="risk-warning.php" target="_parent"> Risk
                    Warning</a></p>
    ...
    <div class="container row">
        <div class="col-12 col-md-7 mx-auto bg-white p-4">
            ...
            <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form'
                  ...
                  autocomplete='on'>
                <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo0OToxNg=='/>
                <input type='hidden' name='token' value='$2y$10$q1XDgI9mZ13lqj32Sx55Me2wFGnMLB.tQlKwrJfo956OT.jkVv5/W'/>
                <input type='hidden' name='source'
                       value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:13] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:14] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:15] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:16] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/about/company-news?web=true'/>
                ...
                <button type='submit' class='btn btn-mex ml-auto btn-submit'
                        onsubmit="if (!window.__cfRLUnblockHandlers) return false; "
                        data-cf-modified-add9bdeab49ae9424dd66d41-="">SEND
                </button>
            </form>
        </div>
    </div>
...
<script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="add9bdeab49ae9424dd66d41-|49" defer=""></script>
</body>
</html>