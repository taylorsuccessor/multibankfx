...
<body>
    ...
    <div class="main-container">
        <section class="flex-center page-top-banner"><img alt="Milestones" data-entity-type="" data-entity-uuid="" src="../public_files/images/about_us/about_milestones_top_banner.jpg" class="mex-img-cover" />
            <div class="container text-center">
                <div class="row">
                    <div class="col-12">
                        <h1 class="mex-h1 text-fff mex-m-b-15"><?php translate('MILESTONES'); ?></h1>
        ...
        <div class="mex-m-b-30">
            ...
            <section class="my-0 py-0">
                <div class="container">
                    <div class="row ml-3"><a href="../article/milestone-multibank-group-establishes-new-branch-in-turkey.html">
            ...
            <section class="my-0 py-0">
                <div class="container">
                    <div class="row ml-3"><a href="../article/milestones_multibank-group-official-partner-bmw-m-motorsport.html">
            ...
            <section class="my-0 py-0">
                <div class="container">
                    <div class="row ml-3"><a href="../article/milestones_interview-multibank-philippines-ceo-mark-mangulabnan.html">
            ...
            <section class="my-0 py-0">
                <div class="container">
                    <div class="row ml-3"><a href="../article/milestones_multibank-latam-regional-headquarter-launched-mexico.html">
            ...
            <section class="my-0 py-0">
                <div class="container">
                    <div class="row ml-3"><a href="../article/milestones_multibank-expansion-large-acquisition-aetos-china.html">
            ...
            <section class="my-0 py-0">
                <div class="container">
                    <div class="row ml-3"><a href="../article/milestones_multibank-chairman-naser-taher-awarded-ceo-of-the-year-2019.html">
                                ...
                                <div class="details-container col-12 col-lg-8 col-xl-9 mt-3 mt-lg-0 py-xl-3 border">
                                    <div class="row">
                                        ...
                                        Hong Kong SFC'); ?>
                                            ...
                                            <div class="summary">
                                                <p>MultiBank has scored a major victory against the Hong Kong
                                ...
                                <div class="details-container col-12 col-lg-8 col-xl-9 mt-3 mt-lg-0 py-xl-3 border">
                                    <div class="row">
                                        ...
                                        <div class="col - 11">
                                            ...
                                            <div class="summary">
                                                <p>Regulated by the Financial Services Commission (FSC) in the
                                ...
                                <div class="details-container col-12 col-lg-8 col-xl-9 mt-3 mt-lg-0 py-xl-3 border">
                                    <div class="row">
                                        ...
                                        <div class="col - 11">
                                            ...
                                            <div class="summary">
                                                <p>In July 2017, MultiBank Group launched its new institutional
                                ...
                                <div class="details-container col-12 col-lg-8 col-xl-9 mt-3 mt-lg-0 py-xl-3 border">
                                    <div class="row">
                                        ...
                                        <div class="col - 11">
                                            ...
                                            <div class="summary">
                                                <p>MultiBank announces the establishment of a ground-breaking
                                ...
                                <div class="details-container col-12 col-lg-8 col-xl-9 mt-3 mt-lg-0 py-xl-3 border">
                                    <div class="row">
                                        ...
                                        with the Tianjin Government of China'); ?>
                                            ...
                                            <div class="summary">
                                                <p>On 17th October 2013, MultiBank Group announced that it has
                                ...
                                <div class="details-container col-12 col-lg-8 col-xl-9 mt-3 mt-lg-0 py-xl-3 border">
                                    <div class="row">
                                        ...
                                        Counselor for the Chinese Government of Tianjin'); ?>
                                            ...
                                            <div class="summary">
                                                <p>On 29th July 2013, Mr. Naser Taher was being honored with
                                ...
                                <div class="details-container col-12 col-lg-8 col-xl-9 mt-3 mt-lg-0 py-xl-3 border">
                                    <div class="row">
                                        ...
                                        <div class="col - 11">
                                            ...
                                            <div class="summary">
                                                <p>MultiBank was awarded by the Global Banking &amp; Finance
                                ...
                                <div class="details-container col-12 col-lg-8 col-xl-9 mt-3 mt-lg-0 py-xl-3 border">
                                    <div class="row">
                                        ...
                                        <div class="col - 11">
                                            ...
                                            <div class="summary">
                                                <p>MultiBank establishes its Australian company MEX Australia
                                ...
                                <div class="details-container col-12 col-lg-8 col-xl-9 mt-3 mt-lg-0 py-xl-3 border">
                                    <div class="row">
                                        ...
                                        <div class="col - 11">
                                            ...
                                            <div class="summary">
                                                <p>On 28th&nbsp;September 2011, MultiBank signed a historical
                                ...
                                <div class="details-container col-12 col-lg-8 col-xl-9 mt-3 mt-lg-0 py-xl-3 border">
                                    <div class="row">
                                        ...
                                        <div class="col - 11">
                                            ...
                                            <div class="summary">
                                                <p>MultiBank raises the bar worldwide in the Foreign Exchange
                                ...
                                <div class="details-container col-12 col-lg-8 col-xl-9 mt-3 mt-lg-0 py-xl-3 border">
                                    <div class="row">
                                        ...
                                        <div class="col - 11">
                                            ...
                                            <div class="summary">
                                                <p>MultiBank was established in the United States in 2005.
                ...
                <div class="col-md-12">
                    ...
                    <div class="icon-next-list">
                        <ul class="bg-white target-icon">
                            ...
                            <li><a href="../index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-d1e42a21540a99ed898e3385-=""><span class="ico-ic_live_chat_support"></span> </a>
                                <div class="mex-content mex-clamp-3"><a href="../index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-d1e42a21540a99ed898e3385-=""><?php translate('Live Chat Support'); ?></a></div>
                                <a href="../index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-d1e42a21540a99ed898e3385-=""> </a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    ...
                    <button type='submit' class='btn btn-mex ml-auto btn-submit' onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-d1e42a21540a99ed898e3385-="">SEND
                    </button>
                </form>
            </div>
        </div>
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="d1e42a21540a99ed898e3385-|49" defer=""></script>
</body>
