...
<body>
    ...
    <div class="main-container">
        ...
        <section class="about-page-awards table-background_1 lazyloaded" data-bg="/public_files/images/about_us/home_awards_bg.png" id="about-page-awards" style="background-image: url('../public_files/images/about_us/home_awards_bg.png');">
            <div class="container">
                <div class="row">
 ...
 <?php include_from_root('website_template/choose_where_to.php');?>
    ...
    <div class="slidebar">
        ...
        <a class="email-us-tg demo-account-btn email-btn" href="cdn-cgi/l/email-protection.php#5e3d2d1e332b322a373c3f30353826703d3133">
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    ...
                    <button type='submit' class='btn btn-mex ml-auto btn-submit' onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-bd9fa8aaa7d9728df9c131fe-="">SEND
                    </button>
                </form>
            </div>
        </div>
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="bd9fa8aaa7d9728df9c131fe-|49" defer=""></script>
</body>
