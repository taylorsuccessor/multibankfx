...
<body>
            ...
            <div class="container">
                <div class="row justify-content-end">
                    <div class="col-md-6 col-sm-12">
                        <h1 class="mex-h1 text-left"><?php translate('Trade Forex'); ?></h1>
                        <div class="mex-content mex-m-b-30">
                            <p class="mex-m-t-15 mex-m-b-15"><?php translate('MultiBank provides forex trading in over 45 currency pairs including majors, cross currencies and exotic currencies.'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="p0 choose-next-background avant-book">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="container">
                            <h1 class="mex-h1 text-fff text-center uppercase mex-p-t-80"><?php translate('Advantages of Forex Trading with MultiBank'); ?></h1>
                        </div>
                    </div>
                        ...
                        <div class="row book-content-inner">
                            <div class="block-img col-lg-5 col-md-12 col-sm-12">
                                <ul class="book-content-ul ">
                                    ...
                                    <!-- <li><?php translate('Tight spreads from 0.1 pips'); ?></li> -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h2 class="mex-h1 mex-m-b-20 text-1e32a3 uppercase"><?php translate('FX Spread Table'); ?></h2>
                        <p class="text-center"><?php translate('Please see below MultiBank’s forex spreads- the tightest in the industry'); ?></p>
                        <div class="table-responsive security-of-funds-table table-content table-incomplete">
                            <table class="table table-striped mex-table mex-has-type text-center">
                                <thead>
                                    <tr>
                                        <th>Currency Pairs<div class="border-right-blue"></div>
                                        </th>
                                        <th>ECN Pro<div class="border-right-blue"></div>
                                        </th>
                                        <th>MultiBank Pro<div class="border-right-blue"></div>
                                        </th>
                                        <th>Maximus</th>
                                    </tr>
                                </thead>
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="4fe19c5a57e80b762e441d20-|49" defer=""></script>
</body>
