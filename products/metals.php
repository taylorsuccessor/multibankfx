...
<body>
    ...
    <div class="main-container">
            ...
            <div class="container">
                <div class="row justify-content-end">
                    <div class="col-sm-6 col-12">
                        <h1 class="mex-h1 text-fff text-left"><?php translate('Trade Metals'); ?></h1>
                        <div class="mex-content mex-m-b-30 text-fff">
                            <p class="mex-m-t-15 mex-m-b-15"><?php translate('With a worldwide network of precious metals dealers, producers, consumers, and speculators, MultiBank brings a breadth of experience to our clients.'); ?></p>
                            <p class="mex-m-t-15 mex-m-b-15"><?php translate('Metals traders will have access to position tracking, account management, narrow spreads.'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-12 col-xs-12">
                        <div class="container">
                            <h1 class="mex-h1 text-white text-center uppercase mex-p-t-80"><?php translate('Advantages of Metals Trading with MultiBank'); ?></h1>
                        </div>
                    </div>
                        ...
                        <div class="row book-content-inner">
                            <div class="block-img col-lg-5 col-md-12 col-sm-12">
                                <ul class="book-content-ul ">
                                    <li><?php translate('Tight spreads from 8 cents on Gold & 3 cents on Silver'); ?></li>
        ...
        <section class="choose-next-background square">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <h2 class="mex-h1 text-center mex-m-b-20 text-1e32a3 uppercase"><?php translate('Metals Spread Table'); ?></h2>
                        <p class="text-center"><?php translate('See below MultiBank’s metals spreads- the tightest in the industry'); ?></p>
                        <div class="table-responsive table-content security-of-funds-table">
                            ...
                            <p class="mex-m-t-15"><?php translate('*Under normal market conditions'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="../public_files/static_js/lang_data/en.js" type="861480a3e7e307a7a0686a5e-text/javascript"></script>
    <script src="../public_files/static_js/jquery.dataTables.min.js" type="861480a3e7e307a7a0686a5e-text/javascript"></script>
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="861480a3e7e307a7a0686a5e-|49" defer=""></script>
</body>
