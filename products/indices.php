...
<body>
            ...
            <div class="container">
                <div class="row justify-content-end">
                    <div class="col-lg-6 col-sm-8 col-8">
                        <h1 class="mex-h1 text-fff text-left"><?php translate('Trade Indices'); ?></h1>
                        <div class="mex-content mex-m-b-30 text-fff">
                            <p class="mex-m-t-15 mex-m-b-15"><?php translate('Trade the global stock indices such the world-renowned US Wall Street 30 index, NASDAQ, German DAX index and more!'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="p0 choose-next-background avant-memo">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-12 mex-h1 text-white text-center uppercase mex-p-t-80 mex-m-b-40"><?php translate('Advantages of Indices Trading with MultiBank'); ?></div>
                    <div class="col-lg-6 col-md-10 col-sm-12 col-12 avant-memo-contianer">
                        <div class="fixed-height-overflow-container">
                            <ul class="book-content-ul">
                                <li><?php translate('Trade index from around the world'); ?></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="mex-h1 text-center mex-m-b-40 text-1e32a3 uppercase"><?php translate('Index Specifications'); ?></div>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h1 text-center mex-m-b-40 text-1e32a3 uppercase"><?php translate('Cash Index Specifications'); ?></div>
                    <div class="table-responsive security-of-funds-table table-content ">
                        <table class="table table-striped mex-table mex-has-type text-center">
                            <thead>
                                <tr>
    ...
    <script src="../public_files/static_js/lang_data/en.js" type="9809ea1d35619c252f27ae70-text/javascript"></script>
    <script src="../public_files/static_js/jquery.dataTables.min.js" type="9809ea1d35619c252f27ae70-text/javascript"></script>
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="9809ea1d35619c252f27ae70-|49" defer=""></script>
</body>
