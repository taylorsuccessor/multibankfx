...
<body>
    <?php include_from_root('website_template/header_and_menu.php'); ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7 col-sm-12">
                        ...
                        <?php translate('CPA Affiliate Program'); ?> </h1>
                        <div class="mex-content mex-m-b-30">
                            <p class="mex-m-t-15"><?php translate('MultiBank’s CPA Affiliate Program allows digital marketers such as portal websites, media buyers, email marketers, affiliate networks, bloggers and influences of the forex or financial services community to earn commission for every active trader they introduce to MultiBank.'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="table-background plants">
            <div class="container">
                <div class="row mex-m-b-40">
                    ...
                    <?php translate('Join mulitibank(s) cpa affiliate program'); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 col-12 mx-auto shadow-box bg-white">
                        <form action="https://www.multibankfx.com/form/partnership?" name='cpa_affiliate_program_form' class='multibank-form  row-offset-5 row padding-20 new' method='post' enctype='' id='cpa_affiliate_program_form' target='' autocomplete='on'>
                            ...
                            </div><button type='submit' class='btn btn-mex mx-auto' onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-2623d498cdd94b5e7a00da13-=""><?php translate('SUBMIT'); ?></button>
                        </form>
        ...
        <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="2623d498cdd94b5e7a00da13-|49" defer=""></script>
    </body>
