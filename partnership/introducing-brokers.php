...
<body>
  ...
  <section class="flex-center page-top-banner">
    <img src="/multibankfx/public_files/images/partnership/introducing_brokers/img_topbanner_Introducing_Brokers.jpg" alt="Introducing Brokers" class="mex-img-cover" />
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-12">
          ...
          <div class="mex-content mex-m-b-30">
            <p class="mex-m-t-15">
            <?php translate('MultiBank is recognized worldwide for its Introducing Broker
  ...
  <section class="bg-white p0 mex-side-full same-height-block">
    <div class="col-xs-12 col-lg-6 p0">
      <div class="flex-center vertical-center">
        <img class="mex-img-cover" src="/multibankfx/public_files/images/partnership/introducing_brokers/img_right_ib_page.png" alt="MultiBank’s IB Program and services include" />
        <div class="both-content p32 pt24 pb24">
          <div class="mex-h2 mex-m-b-15 text-left text-1e32a3 col-xs-12 col-lg-8 left">
          <?php translate('MultiBank’s IB Program'); ?><br /><?php translate('and services include:'); ?>
          </div>
          <div class="mex-content mex-m-b-30">
            <div class="col-xs-12 col-lg-8 left">
              <ul class="mex-list-icon-check">
                <li><?php translate('Industry leading commission and rebate returns'); ?></li>
                <li><?php translate('Customized account opening applications'); ?></li>
                <li><?php translate('Full IB account panel enabling the monitoring of rebates and account movements'); ?></li>
                <li><?php translate('A wide range of trading instruments'); ?></li>
                <li><?php translate('Analysis and technology tools (including MAM and PAMM accounts)'); ?>
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="col-xs-12 col-lg-6 p0">
      <div class="flex-center full-height vertical-center">
        <img class="mex-img-cover" src="/multibankfx/public_files/images/partnership/introducing_brokers/img_left_ib_page.jpg" alt="MultiBank’s IBs Now Enjoy the best Bonuses in the Industry" />
        <div class="both-content col-xs-12 col-lg-10 col-lg-offset-1 text-center p32 pt24 pb24">
          ...
          <?php translate('MultiBank’s IBs Now Enjoy the best Bonuses in the Industry'); ?>
          </div>
          <div class="mex-content mex-m-b-30">
          <?php translate('We value our Introducing Brokers and offer them the most advantageous bonus promotions available.'); ?>
          </div>
          <a href="/multibankfx/account/bonus-ib.php" class="btn btn-mex mex-m-r-15 mex-m-b-15"><?php translate('GET BONUS!'); ?></a>
        </div>
      </div>
    </div>
  </section>
  <section class="table-background keyboard" id="introducing-brokers-form">
    <div class="container">
      ...
      <?php translate('Become A MultiBank Introducing Broker Today!'); ?>
      </div>
      <div class="row">
        <div class="col-lg-8 col-12 mx-auto shadow-box bg-white">
          <form action="https://www.multibankfx.com/form/partnership?" name="ib_form" class="multibank-form row-offset-5 row padding-20 new" method="post" enctype="" id="ib_form" target="" autocomplete="on">
            ...
            <div class="mex-form-item col-6 col-md-6 p-1 send-code-container">
              <button class="btn btn-mex w-100 h-40p send-verification-code-btn min-w-unset" id="button-send-callme_form" type="button" title="Send Code">
                Send Code
              </button>
            </div>
            <div class="mex-form-item col-12 col-md-6 p-1">
            ...
            <div class="d-none">
              <label for="" class="d-none"> <?php translate('Country'); ?></label>
            ...
            <button type="submit" class="btn btn-mex mx-auto" onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-871724c3f7459f328bcb5c51-="">
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xs-12">
          ...
          <?php translate('Advantages of being an Introducing'); ?><br /><?php translate('Broker with MultiBank'); ?>
          </div>
        </div>
      </div>
      <div class="row mex-m-t-15">
        <div class="col-xs-12 col-sm-12 col-lg-6 mb30 mb-sm-16">
          <section class="mex-block-card-v mex-block-card-bg-grey">
            <div class="card-img-box">
              <img class="card-img mex-img-cover" src="/multibankfx/public_files/images/partnership/introducing_brokers/img_partner_point_2.jpg" alt="Full set of marketing materials including brochures, calendars, educational materials and account opening documents" />
            </div>
            <div class="card-content bg-black text-left">
              <span class="text-fff mex-content text-overflow-2">
              <?php translate('Full set of marketing materials including brochures, calendars, educational materials and account opening documents'); ?>
              </span>
            </div>
          </section>
        </div>
        <div class="col-xs-12 col-sm-12 col-lg-6 mb30 mb-sm-16">
          <section class="mex-block-card-v mex-block-card-bg-grey">
            <div class="card-img-box">
              <img class="card-img mex-img-cover" src="/multibankfx/public_files/images/partnership/introducing_brokers/img_partner_point2_2.jpg" alt="Each Introducing Broker will be assigned an experienced IB manager to provide a personal approach to the partnership experience" />
            </div>
            <div class="card-content bg-black text-left">
              <span class="text-fff mex-content text-overflow-2">
              <?php translate('Each Introducing Broker will be assigned an experienced IB manager to provide a personal approach to the partnership experience'); ?>
              </span>
            </div>
          </section>
        </div>
        <div class="col-xs-12 col-sm-6 col-lg-4 mb-md-30 mb-sm-16">
          <section class="mex-block-card-v mex-block-card-bg-grey">
            <div class="card-img-box">
              <img class="card-img mex-img-cover" src="/multibankfx/public_files/images/partnership/introducing_brokers/img_partner_point3_2.jpg" alt="Customized demo and live account opening applications" />
            </div>
            <div class="card-content bg-black text-left">
              <span class="text-fff mex-content text-overflow-3">
              <?php translate('Customized demo and live account opening applications'); ?>
              </span>
            </div>
          </section>
        </div>
        <div class="col-xs-12 col-sm-6 col-lg-4 mb-sm-16">
          <section class="mex-block-card-v mex-block-card-bg-grey">
            <div class="card-img-box">
              <img class="card-img mex-img-cover" src="/multibankfx/public_files/images/partnership/introducing_brokers/img_partner_point4_2.jpg" alt="Year-round promotions, activities and bonuses including lucrative cash and physical prizes" />
            </div>
            <div class="card-content bg-black text-left">
              <span class="text-fff mex-content text-overflow-3">
              <?php translate('Year-round promotions, activities and bonuses including
        ...
        <div class="col-xs-12 col-sm-6 col-lg-4 mb-sm-16">
          <section class="mex-block-card-v mex-block-card-bg-grey">
            <div class="card-img-box">
              <img class="card-img mex-img-cover" src="/multibankfx/public_files/images/partnership/introducing_brokers/img_partner_point5_2.jpg" alt="Unbeatable IB conditions offering the maximum commission and rebate returns on transactions" />
            </div>
            <div class="card-content bg-black text-left">
              <span class="text-fff mex-content text-overflow-3">
              <?php translate('Unbeatable IB conditions offering the maximum commission and
          ...
          <ul class="bg-white target-icon">
            <li>
              <a href="/multibankfx/about/why-multibank-group.php">
                ...
                <div class="mex-content mex-clamp-3"><?php translate('Why Multibank'); ?></div>
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="/multibankfx/about/security-of-funds.php">
                ...
                <div class="mex-content mex-clamp-3"><?php translate('Security of Funds'); ?></div>
              </a>
            </li>
            <li>
              <a href="/multibankfx/about/milestones.php">
                <span class="ico-ic_our_milestones"></span>
                <div class="mex-content mex-clamp-3"><?php translate('Our Milestones'); ?></div>
              </a>
            </li>
            <li>
              <a href="/multibankfx/contact.php">
                ...
                <?php translate('Call Our 24/5 Hotline'); ?>
                </div>
              </a>
            </li>
            <li>
              <a href="/multibankfx/index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-871724c3f7459f328bcb5c51-="">
                <span class="ico-ic_live_chat_support"></span>
                <div class="mex-content mex-clamp-3"><?php translate('Live Chat Support'); ?></div>
              </a>
            </li>
            <li>
              <a href="/multibankfx/investor-relations.php">
                ...
                <div class="mex-content mex-clamp-3">
                <?php translate('Partnership Programs'); ?>
                </div>
              </a>
            </li>
            <li>
              <a href="/multibankfx/account/bonus.php">
                ...
                <div class="mex-content mex-clamp-3"><?php translate('Bonus Programs'); ?></div>
              </a>
            </li>
            <li>
              <a href="introducing-brokers.html#introducing-brokers-form">
                <span class="ico-ic_become_an_ib"></span>
                <div class="mex-content mex-clamp-3"><?php translate('Become an IB'); ?></div>
              </a>
            </li>
            <li>
              <a href="/multibankfx/platforms/compare-platforms.php">
                ...
                <div class="mex-content mex-clamp-3">
                <?php translate('Compare our Trading Platforms'); ?>
                </div>
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="/multibankfx/products.php">
                ...
                <div class="mex-content mex-clamp-3"><?php translate('Our Products'); ?></div>
              </a>
            </li>
          </ul>
        </div>
  ...
  <div class="slidebar">
    ...
    <a class="email-us-tg demo-account-btn email-btn" href="/multibankfx/cdn-cgi/l/email-protection.html#b4d7c7f4d9c1d8c0ddd6d5dadfd2cc9ad7dbd9">
      <span class="btn">
      ...
      <div class="col-12 col-md-7 mx-auto bg-white p-4">
        ...
        <form action="https://www.multibankfx.com/form/contactus?" name="email_us_form" class="multibank-form row mx-0 w-100 new" method="post" enctype="" id="email_us_form" target="" autocomplete="on">
          ...
          <div class="d-none">
            ...
            <div class="form-check form-check-inline">
              <input data-message="Account Type is Required." data-extra-message="Account type Invalid." class="   " name="account_type" type="radio" required value="1" checked />
          ...
          <div class="mex-form-item col-12 mb-3 p-1">
            ...
            <textarea data-message="Message is Required." data-extra-message="Message is Invalid." data-regex="" class="form-control w-100 ta-message" name="message" id="order_message" placeholder="">
Hello, I am interested in learning more about MultiBank products and services. Could you please contact me</textarea>
          </div>
          <button type="submit" class="btn btn-mex ml-auto btn-submit" onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-871724c3f7459f328bcb5c51-="">
            SEND
          </button>
        </form>
      </div>
  ...
  <script src="/multibankfx/public_files/static_js/lang_data/en.js" type="871724c3f7459f328bcb5c51-text/javascript"></script>
  <script src="/multibankfx/public_files/static_js/jquery.dataTables.min.js" type="871724c3f7459f328bcb5c51-text/javascript"></script>
  <script src="/multibankfx/public_files/static_js/lazysizes.min.js" type="871724c3f7459f328bcb5c51-text/javascript"></script>
  <script src="/multibankfx/public_files/static_js/jquery.validate.min.js" type="871724c3f7459f328bcb5c51-text/javascript"></script>
  <script src="/multibankfx/public_files/static_js/intlTelInput.min.js" type="871724c3f7459f328bcb5c51-text/javascript"></script>
  <script src="/multibankfx/public_files/static_js/app.js" type="871724c3f7459f328bcb5c51-text/javascript"></script>
  ...
  <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="871724c3f7459f328bcb5c51-|49" defer=""></script>
</body>
