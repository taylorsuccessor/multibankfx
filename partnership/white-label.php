...
<div class="col-lg-8 col-12 mx-auto shadow-box bg-white">
 <form action="https://www.multibankfx.com/form/partnership?" name='white_label_form' class='multibank-form  row-offset-5 row padding-20 new' method='post' enctype='' id='ib_form' target='' autocomplete='on'>
