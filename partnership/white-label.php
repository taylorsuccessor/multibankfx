...
<body>
    ...
    <section class="flex-center page-top-banner"><img src="/multibankfx/public_files/images/partnership/white_label/img_top_banner_White_Label_banner.jpg" alt="White Label" class="mex-img-cover" />
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <h1 class="mex-h1 text-left"><?php translate('WHITE LABEL'); ?></h1>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-t-15"><?php translate('MultiBank offers a full white label technology package for institutional customers who require their own proprietary trading system, branded in their corporate name, which allows them to become fully independent brokers that offer forex, metals and CFDs.');?></p>
                        <p class="mex-m-t-30"><?php translate('MultiBank customizes the trading systems in accordance with White Label Partner’s needs and requirements.'); ?><br /><?php translate('We deliver the complete A to Z white label system including, but not limited to, two distinct trading platforms, mobile platforms, fully executable prices, account opening systems, back offices, 24/7 technical support, various trading strategies, website development, company formation support and bank account opening assistance.'); ?><br /><?php translate('Please contact us for further details and we will be happy to provide you further information.'); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class=" flex-center">
        <img class="mex-img-cover" src="/multibankfx/public_files/images/partnership/white_label/White_Label_Highlights.png" alt=" White Label Highlights">
        <div class="container">
            <div class="row d-block">
                <div class="col-lg-6 col-sm7 col-xs-12 right">
                    <div class="mex-h1 text-1e32a3 text-left">
                    <?php translate('White Label Highlights'); ?>
                    </div>
                    <div class="mex-content mex-m-b-30">
                        <ul class="mex-list-icon-check">
                            ...
                            <li><?php translate('Full Prime Broker Solutions including API, Gateway and Bridges liquidity connections'); ?></li>
                            <li><?php translate('Specialized tools for client administration, risk management and real-time/end-of-day reporting'); ?></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="table-background plants">
        <div class="container">
            <div class="row mex-m-b-40">
                ...
                <?php translate('Apply to become a white label partner'); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-8 col-12 mx-auto shadow-box bg-white">
                    <form action="https://www.multibankfx.com/form/partnership?" name='white_label_form' class='multibank-form  row-offset-5 row padding-20 new' method='post' enctype='' id='white_label_form' target='' autocomplete='on'>
                        ...
                        </div><button type='submit' class='btn btn-mex mx-auto' onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-c40b9c2b8d5630af90dc13fb-=""><?php translate('SUBMIT'); ?></button>
                    </form>
                    ...
                    <ul class="bg-white target-icon">
                        ...
                        <li>
                            <a href="/multibankfx/contact.php">
                                ...
                                <div class="mex-content mex-clamp-3"><?php translate('Call Our 24/5 Hotline'); ?></div>
                            </a>
                        </li>
                        <li>
                            <a href="/multibankfx/index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-c40b9c2b8d5630af90dc13fb-="">
                        ...
                        <li>
                            <a href="/multibankfx/investor-relations.php">
                                ...
                                <div class="mex-content mex-clamp-3"><?php translate('Partnership Programs'); ?></div>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/multibankfx/platforms/compare-platforms.php">
                                ...
                                <div class="mex-content mex-clamp-3"><?php translate('Compare our Trading Platforms');?></div>
                            </a>
                        </li>
                        <li>
    ...
    <div class="slidebar">
        ...
        <a class="email-us-tg demo-account-btn email-btn" href="/multibankfx/cdn-cgi/l/email-protection.html#97f4e4d7fae2fbe3fef5f6f9fcf1efb9f4f8fa">
    ...
    <script src="/multibankfx/public_files/static_js/lang_data/en.js" type="c40b9c2b8d5630af90dc13fb-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.dataTables.min.js" type="c40b9c2b8d5630af90dc13fb-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/lazysizes.min.js" type="c40b9c2b8d5630af90dc13fb-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.validate.min.js" type="c40b9c2b8d5630af90dc13fb-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/intlTelInput.min.js" type="c40b9c2b8d5630af90dc13fb-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/app.js" type="c40b9c2b8d5630af90dc13fb-text/javascript"></script>
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="c40b9c2b8d5630af90dc13fb-|49" defer=""></script>
</body>
