        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <h1 class="mex-h1 text-left">WHITE LABEL</h1>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-t-15">MultiBank offers a full white label technology package for institutional customers who require their own proprietary trading system, branded in their corporate name, which allows them to become fully independent brokers that offer forex, metals and CFDs.</p>
                        <p class="mex-m-t-30">MultiBank customizes the trading systems in accordance with White Label Partner’s needs and requirements.<br />We deliver the complete A to Z white label system including, but not limited to, two distinct trading platforms, mobile platforms, fully executable prices, account opening systems, back offices, 24/7 technical support, various trading strategies, website development, company formation support and bank account opening assistance.<br />Please contact us for further details and we will be happy to provide you further information.</p>
                    </div>
                </div>
            </div>
        </div>
