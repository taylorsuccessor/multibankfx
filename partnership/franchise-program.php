      ...
      <div class="col-md-12">
        ...
        <div class="icon-next-list">
          <ul class="bg-white target-icon">
            ...
            <li>
              <a href="/multibankfx/index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-9362f7f3cd03477831e71834-="">
