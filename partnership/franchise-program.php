    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-8 col-12 mx-auto shadow-box bg-white">
          <form action="https://www.multibankfx.com/form/partnership?" name="franchise_program_form" class="multibank-form row-offset-5 row padding-20 new" method="post" enctype="" id="franchise_program_form" target="" autocomplete="on">
            <input type="hidden" name="t_date" value="MjAyMC0wNi0yNyAwMjo0OTo0NA==" />
            <input type="hidden" name="token" value="$2y$10$Y074AyBNXor73qUtbqtvLO/379N2EVOyOuyyvxvm5gykhRA0pIjUW" />
            ...
            <div class="">
              ...
              <input type="hidden" data-message="" data-extra-message="" data-regex="" class=" " name="p_type" placeholder="" required value="3" />
            </div>
            <div class="">
              <label for="" class=""> </label>
    ...
    <div class="container row">
      <div class="col-12 col-md-7 mx-auto bg-white p-4">
        ...
        <form action="https://www.multibankfx.com/form/contactus?" name="email_us_form" class="multibank-form row mx-0 w-100 new" method="post" enctype="" id="email_us_form" target="" autocomplete="on">
          <input type="hidden" name="t_date" value="MjAyMC0wNi0yNyAwMjo0OTo0NA==" />
          <input type="hidden" name="token" value="$2y$10$je6iuMO01DJK6w9bpS/Phen5tIWoVikdtxdJecO/MJgbhzUDmsdmG" />
          <input type="hidden" name="source" value="[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:40] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:41] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:43] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:49:45] https://www.multibankfx.com/<br/><br/> <br/><br/> posted From: www.multibankfx.com/partnership/franchise-program?web=true" />
...
Hello, I am interested in learning more about MultiBank products and services. Could you please contact me</textarea>
          ...
          <button type="submit" class="btn btn-mex ml-auto btn-submit" onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-9362f7f3cd03477831e71834-="">
            SEND
          </button>
        </form>
      </div>
  ...
  <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="9362f7f3cd03477831e71834-|49" defer=""></script>
</body>
