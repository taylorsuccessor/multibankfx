...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <?php translate('Introduction'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30">
                            <div><?php translate('MultiBank Group needs to collect personal information from our clients and prospective clients in order to provide them with our products, services and any relevant information. Your privacy is very important to us and we make it our priority to safeguard and secure any and all confidential information relating to individuals.'); ?> </div>
                            <div><?php translate('This Privacy Policy will go through what measures MultiBank Group (the “Company” or “MultiBank”) takes to collects, uses and manages the personal information we receive from you or a third party in relation to the products and services we provide. This Privacy Policy also outlines your rights relating to the processing of your personal information. Our Privacy Policy is reviewed and updated regularly in order to be compliant with data protection laws and other privacy regulations.'); ?></div>
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('MultiBank Group'); ?>
                    </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30">
                            <div><?php translate('MultiBank Group is a Group of companies, with each subsidiary licensed and/or regulated by the relevant local financial authorities.'); ?></div>
                            <div><?php translate('MultiBank Exchange is the trading name of MultiBank Forex Exchange Corporation incorporated in California, USA with Company No. 3918038.'); ?> </div>
                            <div><?php translate('MultiBank FX is the trading name of Multibank FX International Corporation (BVI) with Company No. 1377324.'); ?></div>
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Privacy Protection'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30">
                            <div> <?php translate('MultiBank respects the privacy of any users who access its website(s), and therefore is committed to taking all reasonable steps to safeguard the privacy and confidential information of all clients and visitors of our website, in accordance with the applicable data protection laws and regulations.'); ?></div>
                            <div> <?php translate('To ensure this, we have trained our staff on the importance protecting and respecting your personal information and privacy. We have also appointed a Data Protection Officer to ensure that our Company manages/processes your personal information in compliance with the applicable data protection laws and regulations and in accordance with this Privacy Policy.'); ?> </div>
                            <div> <?php translate('The personal information you provide us with when registering yourself as a user of the Company’s website(s) or of its services is classified as registered information, which is protected in several different ways. You can access your registered information after logging in to MyMultiBank.'); ?> </div>
                            <div> <?php translate('It is your responsibility to make sure that your password is only known to you and not disclosed to anyone else. Your registered information is securely stored with us, and only authorized staff have access to this information. Please also note that transfer of information via the internet is not always entirely secure, but we have taken significant precautions to assure that your personal data is being protected.'); ?></div>
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Personal information we collect'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30">
                            <div> <?php translate('As part of our application process and in order to open any type of account with us, you must first complete and submit an application form with all the required information. By completing this application form, you are requested to disclose personal information in order to enable the Company to assess your application and comply with the relevant laws (including their regulations). The information you provide may also be used by the Company to inform you regarding its services.'); ?></div>
                            <div> <?php translate('The information that we may collect from you includes the following:'); ?></div>
                        </p>
                        <ul class="mex-list-icon-check">
                            <li><?php translate('full name'); ?></li>
                            <li><?php translate('residential address'); ?></li>
                            <li><?php translate('contact details (e.g. telephone number, email address, etc.)'); ?></li>
                            <li><?php translate('date of birth, place of birth, gender, citizenship'); ?></li>
                            <li><?php translate('information about your income and wealth, including details about your source of funds, assets and liabilities, bank account information, trading statements, financial statements'); ?></li>
                            <li><?php translate('trading account balances, trading activity, your inquiries and our responses'); ?></li>
                            <li><?php translate('profession and employment details'); ?></li>
                            <li><?php translate('authentication data (e.g. signature)'); ?></li>
                            <li><?php translate('location data'); ?></li>
                            <li><?php translate('trading performance, knowledge and experience'); ?></li>
                            <li><?php translate('verification information, which includes information necessary to verify your identity such as a passport or driver’s license (examples also include background information we receive about you from public records or from other entities not affiliated with us). Furthermore, we may collect other identifiable information, such as identification numbers and/or passport/tax registration numbers'); ?></li>
                            <li><?php translate('any other information customarily used to identify you and about your trading experience which is relevant to us providing our services to you.'); ?></li>
                        </ul>
                        <p class="mex-m-b-30"><?php translate('We obtain this information in a number of ways through your use of our services, including through any of our websites, apps, the account opening applications, our demo account forms or customer service communications. We may also collect this information about you from third parties such your payment providers and through publicly available sources. We also keep records of your trading behavior, including records regarding the following:'); ?></p>
                        <ul class="mex-list-icon-check">
                            <li><?php translate('products you trade with us and their performance'); ?></li>
                            <li><?php translate('historical data about the trades and investments you have made, including the amount invested'); ?></li>
                            <li><?php translate('your preference for certain types of products and services'); ?></li>
                        </ul>
                        <p class="mex-m-b-30">
                            <div><?php translate('If you choose not to provide the information, we need to fulfil your request for a specific product or service, we may not be able to provide you with the requested product or service.'); ?></div>
                            <div><?php translate('We may record any communications, electronic, by telephone, in person or otherwise, that we have with you in relation to the services we provide to you and our business relationship with you. These recordings will be our sole property and will constitute evidence of the communications between us. Such telephone conversations may be recorded without the use of a warning tone or any other further notice.'); ?></div>
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Processing of your personal information'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('We may process your personal data on the following bases and for the following purposes:'); ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('2. Compliance with a legal obligation'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30">
                            <div><?php translate('There are a number of legal obligations imposed by relevant laws to which we are subject, as well as specific statutory requirements (e.g. anti-money laundering laws, financial services laws, corporation laws, privacy laws and tax laws). There are also various supervisory authorities whose laws and regulations apply to us. Such obligations and requirements impose on us necessary personal data processing activities for credit checks, identity verification, payment processing, compliance with court orders, tax law or other reporting obligations and anti-money laundering controls.'); ?></div>
                            <div><?php translate('These obligations apply at various times, including client on-boarding/acceptance, payments and systemic checks for risk management.'); ?></div>
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('3. For the purposes of safeguarding legitimate interests'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('We process personal data so as to safeguard the legitimate interests pursued by us or by a third party. A legitimate interest is when we have a business or commercial reason to use your information. Examples of such processing activities include the following:'); ?></p>
                        <ul class="mex-list-icon-check">
                            <li><?php translate('initiating legal claims and preparing our defense in litigation procedures'); ?></li>
                            <li><?php translate('risk management'); ?></li>
                            <li><?php translate('measures to manage business and for further developing products and services'); ?></li>
                            <li><?php translate('measures to ensure IT and system security, preventing potential crime, asset security, admittance controls and anti-trespassing measures'); ?></li>
                            <li><?php translate('sharing your personal data within MultiBank Group for the purpose of updating/verifying your personal data in accordance with the relevant anti-money laundering compliance framework'); ?></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('5.To provide you with products and services, or information about our products and services, and to review your ongoing needs'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('Once you successfully open a trading account with us, or subscribe to an update, we will need to use your personal information to perform our services and comply with our obligations to you. It is also in our legitimate interests to try to ensure that we are providing the best products and services so we may periodically review your needs based on our assessment of your personal information to try to ensure that you are getting the benefit of the best possible products and services from us.');?></p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('6.To investigate or settle enquiries or disputes'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('We may need to use personal information collected from you to investigate issues or to settle disputes with you because it is in our legitimate interests to ensure that issues and disputes get investigated and resolved in a timely and efficient manner.'); ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('7.To comply with applicable laws, court orders, other judicial process, or the requirements of any applicable regulatory authorities'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('We may need to use your personal information to comply with any applicable laws and regulations, court orders or other judicial process, or the requirements of any applicable regulatory authority. We do this not only to comply with our legal obligations but because it may also be in our legitimate interest to do so.'); ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('12.Physical security'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('If you enter any of our premises we may record your image on our CCTV for security reasons. We may also take your details to keep a record of who has entered our premises on any given day. It is in our legitimate interest to do this to maintain a safe and secure working environment.'); ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Disclosure of your personal information'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30">
                            <div><?php translate('The Company will not disclose any of its clients’ confidential information to a third party, except: (a) to the extent that it is required to do so pursuant to any applicable laws, rules or regulations; (b) if there is a duty to disclose; (c) if our legitimate business interests require disclosure; or (d) at your request or with your consent or to Persons described in this policy. The Company will endeavor to make such disclosures on a ‘need-to-know’ basis, unless otherwise instructed by a regulatory authority. Under such circumstances, the Company will notify the third party regarding the confidential nature of any such information.'); ?></div>
                            <div><?php translate('As part of using your personal data for the purposes set out above, the Company may disclose your personal information to the following:'); ?></div>
                        </p>
                        <ul class="mex-list-icon-check">
                            <li><?php translate('any companies under MultiBank Group, meaning any of our ultimate holding companies and their respective subsidiaries may receive such information;'); ?></li>
                            <li><?php translate('our associates and service providers, for business purposes, including third parties such as business service providers and specialist advisers who have been contracted to provide us with administrative, financial, legal, tax, compliance, insurance, research or other services;'); ?></li>
                            <li><?php translate('business introducers with whom we have a mutual business relationship;'); ?></li>
                            <li><?php translate('business parties, credit providers, courts, tribunals and regulatory authorities as agreed or authorised by law;'); ?></li>
                            <li><?php translate('anyone authorised by you.'); ?></li>
                        </ul>
                        <p class="mex-m-b-30"><?php translate('If the Company discloses your personal information to business parties, such as card or other payment processing companies or banks, in order to perform the services requested by clients, such third parties may store your information in order to comply with their legal and other obligations.<br />Clients accept and consent that the Company may, from time to time, analyze the data collected while visiting our website(s) or by other means, such as questionnaires, for statistical purposes in order to improve the Company’s business activities.'); ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Your collected information'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('Tracking systems used on the Company’s website(s) may collect your personal data in order to optimize the services provided to clients/potential clients. The website collects information in the following ways:'); ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Device information'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('By recognizing your device used to access and use the Company’s website(s), we can provide you with the most appropriate version of our website(s).'); ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Log information'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('Logging certain behaviors on the site enables the company to track user action and therefore troubleshoot any issues that may occur.'); ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Location information'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('Using your IP address helps us localize our website content, which we provide to you based on your country, and improve your user experience on our site(s).'); ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <?php translate('Cookies'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('Cookies are small pieces of data sent from our website(s) to your browser and stored on your computer’s hard drive when using our site(s), and they may include a unique identification number. The purpose of collecting this information is to provide you with a more relevant and effective experience on our website(s), including the presentation of our web pages according to your needs or preferences.');?><br /><?php translate('Cookies are frequently used on many websites on the internet, and you can choose if and how a cookie will be accepted by changing your preferences and options in your browser. You may not be able to access some parts of our website(s) if you choose to disable the cookie acceptance in your browser, particularly in your MyMultiBank account panel and other secure parts of our website(s). We therefore recommend you to enable cookie acceptance in order to benefit from all our online services.'); ?><br /><?php translate('Furthermore, we use cookies for re-marketing features in order to allow us to reach out to users who have previously visited our website(s) and have shown an interest in our products and services. Periodically, we may use third party vendors to display our ads over the internet to you, based on your previous use of our website(s). You can opt out this particular use of cookies at any time by visiting'); ?> <a href="https://www.google.com/settings/ads" class="text-1e32a3"><?php translate('Google’s Ads Settings'); ?></a> <?php translate('page and the'); ?><a href="https://www.google.com/settings/ads/onweb#display_optout" class="text-1e32a3"><?php translate('DoubleClick opt-out'); ?></a> <?php translate('page or as they later update those facilities.'); ?><br /><?php translate('The Company uses session ID cookies and persistent cookies. A session ID cookie expires after a set amount of time or when the browser window is closed. A persistent cookie remains on your hard drive for an extended time period. You can remove persistent cookies by following directions provided in your web browser(s) ‘Help’ file.'); ?><br /><?php translate('For further details about our cookie policy and how our cookies work, read our'); ?> <a href="cookie-policy.php" class="text-1e32a3"><?php translate('Cookies Policy'); ?></a>.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('How we obtain your consent');?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30">
                            <div><?php translate('If our use of your personal information requires your consent, such consent will be provided in accordance with the express written terms which govern our business relationship (which are available on our website(s), as amended from time time), or any other contract we may have entered into with you or as set out in our communication with you from time to time. If we rely on your consent as our legal basis for holding and processing your personal information, you have the right to withdraw that consent at any time by contacting us using the contact details set out in this Privacy Policy.'); ?></div>
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Storage of your personal information and retention period'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30">
                            <div><?php translate('In relation to your personal information, we will hold this for as long as we have a business relationship with you, in a combination of secure computer storage facilities and paper-based files and other records and we take the necessary measures to protect the personal information we hold from misuse, loss, unauthorized access, modification or disclosure.'); ?> </div>
                            <div><?php translate('When we consider that personal information is no longer necessary for the purpose for which it was collected, we will remove any details that will identify you or we will securely destroy the records. However, we may need to maintain records for a significant period of time (after you cease being our client). For example, we are subject to certain anti-money laundering laws which require us to retain the following, for a period of 5 years after our business relationship with you has ended:'); ?></div>
                        </p>
                        <ul class="mex-list-icon-check">
                            <li><?php translate('a copy of the documents we used in order to comply with our customer due diligence obligations;'); ?></li>
                            <li><?php translate('supporting evidence and records of transactions with you and your relationship with us'); ?></li>
                        </ul>
                        <p class="mex-m-b-30">
                            <div><?php translate('Also, the personal information we hold in the form of a recorded communication, by telephone, electronically, in person or otherwise, will be held in line with local regulatory requirements (i.e., 5 years after our business relationship with you has ended or longer if you have legitimate interests (such as handling a dispute with you). If you have opted out of receiving marketing communications we will hold your details on our suppression list so that we know you do not want to receive these communications.'); ?></div>
                            <div><?php translate('We may keep your data for longer than 5 years if we cannot delete it for legal, regulatory or technical reasons.'); ?></div>
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Your rights regarding your personal information'); ?>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Information and access'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('You have the right to request what information we process, along with a copy of that personal information within thirty (30) days from the date of your request. If you require additional copies, we may need to charge a administration fee.'); ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Rectification'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('We will take all reasonable steps to make sure that your personal information remains accurate, complete and up-to-date. If the personal information we hold about you is inaccurate or incomplete, you are entitled to have it rectified. If we have disclosed your personal information to others, we will let them know about the rectification where possible. You may inform us at any time that your personal details have changed by e-mailing us at'); ?></p>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Erasure'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('You can ask us to delete or remove your personal information in certain circumstances such as if we no longer need it or you withdraw your consent (if applicable) provided that we have no legal obligation to retain that data. Such request will be subject to any retention limits we are required to comply with in accordance with applicable laws and regulations. If we have disclosed your personal information to others, we will let them know about the erasure where possible.'); ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Data portability'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('Under the General Data Protection Regulation (679/2016), you have the right, in certain circumstances, to obtain personal information you have provided us with (in a structured, commonly used and machine readable format) and to re-use it elsewhere or ask us to transfer this to a third party of your choice.'); ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Objection');?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('You can ask us to stop processing your personal information, and we will do so, if we are:'); ?></p>
                        <ul class="mex-list-icon-check">
                            <li><?php translate('relying on our own or someone else’s legitimate interests to process your personal information except if we can demonstrate compelling legal grounds for the processing;'); ?></li>
                            <li><?php translate('processing your personal information for direct marketing;'); ?></li>
                            <li><?php translate('processing your personal information for research unless we reasonably believe such processing is necessary or prudent for the performance of a task carried out in the public interest (such as by a regulatory or enforcement agency).'); ?></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('Opt-out of submitting your personal information'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('If you do not want us to use your personal information, you must inform the Company by sending an email to');?> <a href="cdn-cgi/l/email-protection.html#d5b6a695b8a0b9a1bcb7b4bbbeb3adfbb6bab8" class="text-1e32a3"><span class="__cf_email__" data-cfemail="9dfeeeddf0e8f1e9f4fffcf3f6fbe5b3fef2f0">[email&#160;protected]</span></a> . <?php translate('If you decide to do so, we may not be able to continue to provide information, services and/or products requested by you and we will have no liability to you in this respect.');?></p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="mex-h3 mex-m-b-15">
                    <?php translate('How to contact us'); ?> </div>
                    <div class="mex-content mex-m-b-30">
                        <p class="mex-m-b-30"><?php translate('If you have any questions or concerns regarding this Privacy Policy, please e-mail us at'); ?> <a href="cdn-cgi/l/email-protection.html#2d4e5e6d40584159444f4c43464b55034e4240" class="text-1e32a3"><span class="__cf_email__" data-cfemail="e98a9aa9849c859d808b8887828f91c78a8684">[email&#160;protected]</span></a>.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="043ac85ce02ef20987f94e50-|49" defer=""></script>
</body>
