...
<body>
                ...
                <div class="col-12 col-lg-4 article-right-container">
                    <div class="border-form mex-p-h-15 mb-4">
                        <form action="https://www.multibankfx.com/form/contactus?" name='contact_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='contact_us_form' target='' autocomplete='on'>
                            ...
                            <button type='submit' class='btn-contact mx-1 mt-2 mb-0' onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-096db6e9f7a39679f48ad6f8-="">SUBMIT
                            </button>
                        </form>
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="multibank-chosen-best-FX-CFD-broker-2019.php" class="text-left article-thumbnail-text c933">MultiBank Chosen as Best FX & CFD Broker
                                    (Europe & Asia) 2019 by International Investor Magazine
                                </a>
                                <div class="text-left article-thumbnail-text">2019-05-27
                                </div>
                            </div>
                        </div>
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="multibank-named-best-financial-derivatives-broker-2019.php" class="text-left article-thumbnail-text c1001">
                                    Global Banking & Finance Review Names MultiBank “Best Financial Derivatives Broker 2019”
                                </a>
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="news_20171115.php" class="text-left article-thumbnail-text c1131">
                                    MultiBank Launches MetaTrader 5 Platforms: MT5 Standard & MT5 Pro
                                </a>
                                <div class="text-left article-thumbnail-text">
                                    2017-11-15
                                </div>
                        ...
                        <div class="row side-news-frame mx-0 mb-3">
                            ...
                            <div class="side-news-text col-6 px-0 text-left">
                                <a href="news_20170624.php" class="text-left article-thumbnail-text c1196">
                                    MultiBank- Diamond Sponsor at 2017 Shanghai Brokers Show
                                </a>
                                <div class="text-left article-thumbnail-text">
                                    2017-06-24
                                </div>
    ...
    <div class="slidebar">
        ...
        <a class="ib-registration-btn chat-btn" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-096db6e9f7a39679f48ad6f8-="">
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    ...
                    <button type='submit' class='btn btn-mex ml-auto btn-submit' onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-096db6e9f7a39679f48ad6f8-="">SEND
                    </button>
                </form>
            </div>
        </div>
    ...
    <script type="096db6e9f7a39679f48ad6f8-text/javascript">
        $(function() {
    ...
    <script src="/multibankfx/public_files/static_js/lang_data/en.js" type="096db6e9f7a39679f48ad6f8-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.dataTables.min.js" type="096db6e9f7a39679f48ad6f8-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/lazysizes.min.js" type="096db6e9f7a39679f48ad6f8-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.validate.min.js" type="096db6e9f7a39679f48ad6f8-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/intlTelInput.min.js" type="096db6e9f7a39679f48ad6f8-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/app.js" type="096db6e9f7a39679f48ad6f8-text/javascript"></script>
    <script type="096db6e9f7a39679f48ad6f8-text/javascript" async>
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="096db6e9f7a39679f48ad6f8-|49" defer=""></script>
</body>
