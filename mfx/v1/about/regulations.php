...
<body>
    ...
    <div class="main-container">
        <section class="pt64 pb16 table-background global-presence regulations-bg" style="background-image: url(../public_files/images/about_us/regulations/regulations_fma.jpg);">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-10 col-sm-9 clear-float">
                        ...
                        <div class="swiper-pagination swiper-pagination-white swiper-pagination-clickable swiper-pagination-bullets">
                            <span class="swiper-pagination-bullet" data-img="/multibankfx/public_files/images/common/country/australia.png" tabindex="0" role="button" aria-label="Go to slide 1">
                                <span>ASIC</span>
                                <img src="/multibankfx/public_files/images/common/country/australia.png">
                            </span>

                            <span class="swiper-pagination-bullet" data-img="/multibankfx/public_files/images/common/country/germany.png" tabindex="0" role="button" aria-label="Go to slide 3">
                                <span>BaFin</span>
                                <img src="/multibankfx/public_files/images/common/country/germany.png">
                            </span>
                            <span class="swiper-pagination-bullet swiper-pagination-bullet-active" data-img="/multibankfx/public_files/images/common/country/austria.png" tabindex="0" role="button" aria-label="Go to slide 4">
                                <span>FMA</span>
                                <img src="/multibankfx/public_files/images/common/country/austria.png">
                            </span>
                            <span class="swiper-pagination-bullet" data-img="/multibankfx/public_files/images/common/country/spain.png" tabindex="0" role="button" aria-label="Go to slide 5">
                                <span>CNMV</span>
                                <img src="/multibankfx/public_files/images/common/country/spain.png">
                            </span>
                            <span class="swiper-pagination-bullet" data-img="/multibankfx/multibankfx/public_files/images/common/country/british_virgin_islands.png" tabindex="0" role="button" aria-label="Go to slide 6">
                                <span>FSC</span>
                                <img src="/multibankfx/public_files/images/common/country/british_virgin_islands.png">
                            </span>
                            <span class="swiper-pagination-bullet" data-img="/multibankfx/public_files/images/common/country/cayman_islands.png" tabindex="0" role="button" aria-label="Go to slide 7">
                                <span>CIMA</span>
                                <img src="/multibankfx/public_files/images/common/country/cayman_islands.png">
                            </span>
                            <span class="swiper-pagination-bullet" data-img="/multibankfx/public_files/images/common/country/uae.png" tabindex="0" role="button" aria-label="Go to slide 8">
                                <span>RAK</span>
                                <img src="/multibankfx/public_files/images/common/country/uae.png">
                            </span>
                        </div>
                        <div class="swiper-container swiper-container-horizontal" id="regulations-global-presence">
                            <div class="swiper-wrapper mex-m-b-100 mex-m-t-15" style="transition-duration: 0ms; transform: translate3d(-2925px, 0px, 0px);">
                                <div class="swiper-slide swiper-slide-duplicate" data-img="/resource/newwebsite/v1_0/images/about_us/regulations/regulations_rak@2x.jpg" data-swiper-slide-index="8" style="width: 975px;">
                                    <section class="mex-block-card-not-img">
                                        <div class="card-content bg-white">
                                            ...
                                            <a href="https://www.multibankfx.com/public_files/pdf/MEX_Clearing.pdf" class="btn btn-mex-black mex-m-r-15" target="_blank">License PDF</a>
                                        </div>
                                    </section>
                                </div>
                                <div class="swiper-slide" data-img="/multibankfx/public_files/images/about_us/regulations/regulations_asic.jpg" data-swiper-slide-index="1" style="width: 975px;">
                                    <section class="mex-block-card-not-img">
                                        <div class="card-content bg-white">
                                            <div class="mex-h3-s mex-m-b-15">
                                            ...
                                            <div class="mex-content">
                                                ...
                                                Ltd.'); ?> </div>
                                            <a href="https://connectonline.asic.gov.au/RegistrySearch/faces/landing/SearchRegisters.jspx?_adf.ctrl-state=lffqbm9qo_36" target="_blank" class="btn btn-mex mex-m-r-15"><?php translate('License link'); ?></a>
                                            <a href="http://download.mexgroup.com/uploads/PDFs/ASIC_Company_Certificate.pdf" class="btn btn-mex-black mex-m-r-15" target="_blank"><?php translate('License PDF'); ?></a>
                                        </div>
                                    </section>
                                </div>

                                <div class="swiper-slide swiper-slide-prev" data-img="/multibankfx/public_files/images/about_us/regulations/regulations_bafin.jpg" data-swiper-slide-index="3" style="width: 975px;">
                                    <section class="mex-block-card-not-img">
                                        <div class="card-content bg-white">
                                            <div class="mex-h3-s mex-m-b-15">
                                            ...
                                            <div class="mex-content">
                                                ...
                                                HRB 73406.'); ?> </div>
                                            <a href="https://www.bafin.de/SharedDocs/Standardartikel/EN/Unternehmensdatenbank/li_fidi_zugel_gesamt_en.html?nn=7856472" target="_blank" class="btn btn-mex mex-m-r-15"><?php translate('License link'); ?></a>
                                            <a href="http://download.mexgroup.com/uploads/PDFs/MEXAM-BaFin.pdf" class="btn btn-mex-black mex-m-r-15" target="_blank"><?php translate('License PDF'); ?></a>
                                        </div>
                                    </section>
                                </div>
                                <div class="swiper-slide swiper-slide-active" data-img="/multibankfx/public_files/images/about_us/regulations/regulations_fma.jpg" data-swiper-slide-index="4" style="width: 975px;">
                                    <section class="mex-block-card-not-img">
                                        <div class="card-content bg-white">
                                            <div class="mex-h3-s mex-m-b-15">
                                            ...
                                            <a href="http://www.fma.gv.at/en/search-company-database/?cname=MEX+Asset+Management&amp;place=&amp;bic=&amp;category=&amp;per_page=10&amp;submitted=1" target="_blank" class="btn btn-mex mex-m-r-15"><?php translate('License link'); ?></a>

                                        </div>
                                    </section>
                                </div>
                                <div class="swiper-slide swiper-slide-next" data-img="/multibankfx/public_files/images/about_us/regulations/regulations_cnmv.jpg" data-swiper-slide-index="5" style="width: 975px;">
                                    <section class="mex-block-card-not-img">
                                        <div class="card-content bg-white">
                                            <div class="mex-h3-s mex-m-b-15">
                                            ...
                                            <a href="https://www.cnmv.es/Portal/Consultas/ESI/ESISExtranjerasSuc.aspx?tipo=CSU&numero=120&vista=0&fs=08/04/2019" class="btn btn-mex mex-m-r-15"><?php translate('License link'); ?></a>
                                            <a href="/multibankfx/multibankfx/public_files/images/documents/pdf/CNMV-license.pdf" class="btn btn-mex-black mex-m-r-15"><?php translate('License PDF'); ?></a>
                                        </div>
                                    </section>
                                </div>
                                <div class="swiper-slide" data-img="/multibankfx/public_files/images/about_us/regulations/regulations_fsc.jpg" data-swiper-slide-index="6" style="width: 975px;">
                                    <section class="mex-block-card-not-img">
                                        <div class="card-content bg-white">
                                            <div class="mex-h3-s mex-m-b-15">
                                            ...
                                            <a href="http://www.bvifsc.vg/search/site/multibank" target="_blank" class="btn btn-mex mex-m-r-15"><?php translate('License link'); ?></a>
                                            <a href="http://download.mexgroup.com/uploads/PDFs/FSC_Company_License.pdf" target="_blank" class="btn btn-mex-black mex-m-r-15"> <?php translate('License PDF'); ?></a>
                                        </div>
                                    </section>
                                </div>
                                <div class="swiper-slide" data-img="/multibankfx/public_files/images/about_us/regulations/regulations_cima.jpg" data-swiper-slide-index="7" style="width: 975px;">
                                    <section class="mex-block-card-not-img">
                                        <div class="card-content bg-white">
                                            <div class="mex-h3-s mex-m-b-15">
                                            ...
                                            <a href="http://www.cima.ky/search-entities" target="_blank" class="btn btn-mex mex-m-r-15">License link</a>
                                            <a href="http://download.mexgroup.com/uploads/PDFs/MEX_Wealth_Management_Corporation_Certificate.pdf" target="_blank" class="btn btn-mex-black mex-m-r-15"><?php translate('License PDF'); ?></a>
                                        </div>
                                    </section>
                                </div>

                                <div class="swiper-slide swiper-slide-duplicate" data-img="/multibankfx/public_files/images/about_us/regulations/regulations_asic.jpg" data-swiper-slide-index="1" style="width: 975px;">
                                    <section class="mex-block-card-not-img">
                                        <div class="card-content bg-white">
                                            <div class="mex-h3-s mex-m-b-15">
                                                ASIC<br>MEX Exchange </div>
                                            <div class="mex-content">
                                                ...
                                                416279. MEX Exchange is a registered business name of MEX Australia Pty
                                                Ltd.'); ?> </div>
                                            <a href="http://connectonline.asic.gov.au/RegistrySearch/faces/landing/SearchRegisters.jspx?_adf.ctrl-state=vp4ojzdrf_4" target="_blank" class="btn btn-mex mex-m-r-15"><?php translate('License link'); ?></a>
                                            <a href="http://download.mexgroup.com/uploads/PDFs/ASIC_Company_Certificate.pdf" class="btn btn-mex-black mex-m-r-15" target="_blank"><?php translate('License PDF'); ?></a>
                                        </div>
                                    </section>
                                </div>
            ...
            <div class="swiper-button-next swiper-button-white" tabindex="0" role="button" aria-label="Next slide" style="right: 370.5px;"></div>
            <div class="swiper-button-prev swiper-button-white" tabindex="0" role="button" aria-label="Previous slide" style="left: 370.5px;"></div>


            <img class="regulations-hidden-image" src="/multibankfx/public_files/images/about_us/regulations/regulations_asic.jpg" />
            <img class="regulations-hidden-image" src="/multibankfx/public_files/images/about_us/regulations/regulations_rak.jpg" />
            <img class="regulations-hidden-image" src="/multibankfx/public_files/images/about_us/regulations/regulations_bafin.jpg" />
            <img class="regulations-hidden-image" src="/multibankfx/public_files/images/about_us/regulations/regulations_cnmv.jpg" />
            <img class="regulations-hidden-image" src="/multibankfx/public_files/images/about_us/regulations/regulations_cima.jpg" />
            <img class="regulations-hidden-image" src="/multibankfx/public_files/images/about_us/regulations/regulations_fsc.jpg" />
            <img class="regulations-hidden-image" src="/multibankfx/public_files/images/about_us/regulations/regulations_fma.jpg" />
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="icon-next-list">
                        <ul class="bg-white target-icon">
                            <li><a href="regulations.php"><span class="ico-ic_our_regulations">&nbsp;</span></a>
                            ...
                            <li><a href="/multibankfx/products.php"><span class="ico-ic_our_products"></span> </a>
                                <div class="mex-content mex-clamp-3"><a href="/multibankfx/products.php"><?php translate('Our Products'); ?></a>
                                </div>
                            ...
                            <li><a href="regulations.php"><span class="ico-ic_our_regulations">&nbsp;</span> </a>
                                <div class="mex-content mex-clamp-3"><a href="regulations.php"><?php translate('Our Regulations'); ?></a>
                                </div>
                                <a href="regulations.php"> </a>
                            </li>
                            ...
                            <li><a href="/multibankfx/account.php"><span class="ico-ic_accounts_funding"></span> </a>
                                <div class="mex-content mex-clamp-3"><a href="/multibankfx/account.php"><?php translate('Accounts and
                                        Funding'); ?></a></div>
                                <a href="/multibankfx/account.php"> </a>
                            </li>
                            <li><a href="/multibankfx/account/bonus.php"><span class="ico-ic_bonus_programs"></span> </a>
                                <div class="mex-content mex-clamp-3"><a href="/multibankfx/account/bonus.php"><?php translate('Bonus
                                        Programs'); ?></a></div>
                            ...
                            <li><a href="/multibankfx/partnership/introducing-brokers.html#introducing-brokers-form"><span class="ico-ic_become_an_ib"></span> </a>
                                <div class="mex-content mex-clamp-3"><a href="/multibankfx/partnership/introducing-brokers.html#introducing-brokers-form"><?php translate('Become
                                        an IB'); ?></a></div>
                                <a href="/multibankfx/partnership/introducing-brokers.html#introducing-brokers-form"> </a>
                            </li>
                            <li><a href="/multibankfx/about/milestones.php"><span class="ico-ic_our_milestones"></span>
                                </a>
                                <div class="mex-content mex-clamp-3"><a href="/multibankfx/about/milestones.php"><?php translate('Our
                                        Milestones'); ?></a></div>
                                <a href="/multibankfx/about/milestones.php"> </a>
                            </li>
                            <li><a href="/multibankfx/index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-a6230ba13658041f0e1db4b9-=""><span class="ico-ic_live_chat_support"></span> </a>
                                <div class="mex-content mex-clamp-3"><a href="/multibankfx/index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-a6230ba13658041f0e1db4b9-=""><?php translate('Live Chat Support'); ?></a></div>
                                <a href="/multibankfx/index.html#" onclick="if (!window.__cfRLUnblockHandlers) return false; LC_API.open_chat_window();return false;" data-cf-modified-a6230ba13658041f0e1db4b9-=""> </a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="slidebar">
        ...
        <a class="email-us-tg demo-account-btn email-btn" href="/multibankfx/cdn-cgi/l/email-protection.html#b9dacaf9d4ccd5cdd0dbd8d7d2dfc197dad6d4">
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    ...
                    <input type='hidden' name='token' value='$2y$10$AUW9wa5LzWxDax/ehGScFO49qTK3r4pwGVj9MvM6cgh9jS359ypVa' />
                    <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:53:20] https://www.multibankfx.com/about<br/><br/>[2020-06-27 02:53:22] https://www.multibankfx.com/about<br/><br/>[2020-06-27 02:53:24] https://www.multibankfx.com/about<br/><br/>[2020-06-27 02:53:30] https://www.multibankfx.com/about<br/><br/> <br/><br/> posted From: www.multibankfx.com/about/regulations?web=true' />
                    ...
                    </div><button type='submit' class='btn btn-mex ml-auto btn-submit' onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-a6230ba13658041f0e1db4b9-="">SEND</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script src="/multibankfx/public_files/static_js/lang_data/en.js" type="a6230ba13658041f0e1db4b9-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.dataTables.min.js" type="a6230ba13658041f0e1db4b9-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/lazysizes.min.js" type="a6230ba13658041f0e1db4b9-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/jquery.validate.min.js" type="a6230ba13658041f0e1db4b9-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/intlTelInput.min.js" type="a6230ba13658041f0e1db4b9-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/app.js" type="a6230ba13658041f0e1db4b9-text/javascript"></script>
    ...
    <script src="/multibankfx/public_files/static_js/swiper-4.3.5.min.js" type="a6230ba13658041f0e1db4b9-text/javascript"></script>
    <script src="/multibankfx/public_files/static_js/app_home.js" type="a6230ba13658041f0e1db4b9-text/javascript"></script>
    <script type="a6230ba13658041f0e1db4b9-text/javascript">
        $(function() {
            //icons we need
            var icons = [
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="a6230ba13658041f0e1db4b9-|49" defer=""></script>
</body>
