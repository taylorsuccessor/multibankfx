        ...
        <div class="row">
            <div class="col-sm-6">
                <ul class="header-top-left-menu hide-1024">
                    <li class="border-right hide-1200"><a href="../cdn-cgi/l/email-protection.html#a3c0d0e3ced6cfd7cac1c2cdc8c5db8dc0ccce"><i class="ti-email">&nbsp;</i> <span>EMAIL</span> </a></li>
            ...
            <div class="col-md-6 col-12 header-top-right-menu text-nowrap"><a class="hide-1200 btn btn-sm btn-navy mr-1 d-flex align-items-center" href="https://my.multibankfx.com/en/traders/login"><span class="small-M-logo"><img alt="" data-entity-type="" data-entity-uuid="" height="12px" src="../public_files/images/common/icons/btn_mymex_icon.png" width="auto;" /> </span>&nbsp;MyMultibank
                </a>
                ...
                <a class="btn btn-sm btn-grey hide-768 mr-1 d-flex align-items-center" href="../partnership/introducing-brokers.html"><i style="font-family: 'icomoon' !important; font-size:9px; font-style: normal; margin-right: 5px;">&nbsp;&#xe920;</i>IB
                    Registration</a></div>
        </div>
    </div>
            ...
            <ul class="nav-menu py-3">
                    ...
                    <div class="w-75 mx-auto row">
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="menu_txt_content">
                                <div class="mex-h2 uppercase mb0 "><a class="font-40  text-left mex-p-l-none mex-p-r-none" href="../about.html">About
                                        us</a>
                                </div>
                ...
                <li class="nav-products-menu header-nav-menu" style="display: none;">
                    <div class="w-75 mx-auto row">
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="menu_txt_content">
                                <div class="mex-h2 uppercase mb0"><a class="font-40  text-left mex-p-l-none mex-p-r-none" href="../products.html">Products</a>
                                </div>
                ...
                <li class="nav-platforms-menu header-nav-menu" style="display: none;">
                    <div class="w-75 mx-auto row">
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="menu_txt_content">
                                <div class="mex-h2 uppercase mb0"><a class="font-40  text-left mex-p-l-none mex-p-r-none" href="../platforms.html">Platforms</a>
                                </div>
                ...
                <li class="nav-partnership-menu header-nav-menu" style="display: none;">
                    <div class="w-75 mx-auto row">
                        <div class="col-md-4 col-sm-12  col-xs-12 ">
                            <div class="menu_txt_content">
                                <div class="mex-h2 uppercase mb0"><a class="font-40 text-left mex-p-l-none mex-p-r-none" href="../investor-relations.html">Partnership</a>
                                </div>
