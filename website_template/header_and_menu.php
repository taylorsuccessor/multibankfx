        ...
        <div class="row">
            <div class="col-sm-6">
                <ul class="header-top-left-menu hide-1024">
                    <li class="border-right hide-1200"><a href="cdn-cgi/l/email-protection.php#8ae9f9cae7ffe6fee3e8ebe4e1ecf2a4e9e5e7"><i class="ti-email">&nbsp;</i> <span><?php translate('EMAIL') ?></span> </a></li>
            ...
            <div class="col-md-6 col-12 header-top-right-menu text-nowrap"><a class="hide-1200 btn btn-sm btn-navy mr-1 d-flex align-items-center" href="https://my.multibankfx.com/en/traders/login"><span class="small-M-logo"><img alt="" data-entity-type="" data-entity-uuid="" height="12px" src="public_files/images/common/icons/btn_mymex_icon.png" width="auto;" /> </span>&nbsp;<?php translate('MyMultibank'); ?>
                ...
                <a class="btn btn-sm btn-grey hide-768 mr-1 d-flex align-items-center" href="/multibankfx/partnership/introducing-brokers.php"><i style="font-family: 'icomoon' !important; font-size:9px; font-style: normal; margin-right: 5px;">&nbsp;&#xe920;</i><?php translate('IB Registration'); ?></a></div>
        </div>
    </div>
            ...
            <div class="row nav-bar justify-content-between mx-0">
                ...
                <div class="line-height-75 hide-1200 d-flex">
                    <div class="header-bottom-nav">
                        <div class="nav-item"><a class="header-menu-trigger" data-type="/multibankfx/about"><?php translate('ABOUT US'); ?></a></div>
                        <div class="nav-item"><a class="header-menu-trigger" data-type="/multibankfx/products"><?php translate('PRODUCTS'); ?></a></div>
                        <div class="nav-item"><a class="header-menu-trigger" data-type="/multibankfx/platforms"><?php translate('PLATFORMS'); ?></a></div>
                        <div class="nav-item"><a class="header-menu-trigger" data-type="accounts"><?php translate('ACCOUNT & FUNDING'); ?></a></div>
                        <div class="nav-item"><a class="header-menu-trigger" data-type="tools"><?php translate('TOOLS'); ?></a></div>
                        <div class="nav-item"><a class="header-menu-trigger" data-type="partnership"><?php translate('PARTNERSHIP'); ?></a>
                        </div>
                    </div>
                    <div class="lang-menu">
            ...
            <ul class="nav-menu py-3">
                    ...
                    <div class="w-75 mx-auto row">
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="menu_txt_content">
                                <div class="mex-h2 uppercase mb0 "><a class="font-40  text-left mex-p-l-none mex-p-r-none" href="/multibankfx/about.php"><?php translate('About
                                        us'); ?></a>
                                </div>
                                <p class="line-height-30"><?php translate('MultiBank was established in California, USA in 2005. '); ?> <?php translate('Since
                                    its launch MultiBank has evolved into one of the largest financial derivatives companies worldwide,'); ?> <?php translate('with a current paid up capital of over US $322 million.'); ?></p>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-12 col-xs-12 nav-col-hr">
                            ...
                            <ul class="nav-menu-list">
                                ...
                                <li><a href="/multibankfx/about/career.php"><?php translate('Career'); ?></a></li>
                            </ul>
                        </div>
                        <div class="col-md-4 col-sm-12 col-xs-12 ">
                            <div class="menu_ad">
                ...
                <li class="nav-products-menu header-nav-menu" style="display: none;">
                    <div class="w-75 mx-auto row">
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="menu_txt_content">
                                <div class="mex-h2 uppercase mb0"><a class="font-40  text-left mex-p-l-none mex-p-r-none" href="/multibankfx/products.php"><?php translate('Products'); ?></a>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12 nav-col-hr">
                            ...
                            <ul class="nav-menu-list">
                                ...
                                <li><a href="/multibankfx/products/shares.php"><?php translate('Shares'); ?></a></li>
                                <li><a href="/multibankfx/products/indices.php"><?php translate('Indices'); ?></a></li>
                                <li><a href="/multibankfx/products/commodities.php"><?php translate('Commodities'); ?></a></li>
                ...
                <li class="nav-platforms-menu header-nav-menu" style="display: none;">
                    <div class="w-75 mx-auto row">
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="menu_txt_content">
                                <div class="mex-h2 uppercase mb0"><a class="font-40  text-left mex-p-l-none mex-p-r-none" href="/multibankfx/platforms.php"><?php translate('Platforms'); ?></a>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12 nav-col-hr">
                            ...
                            <ul class="nav-menu-list">
                                ...
                                <li><a href="/multibankfx/platforms/multibank-pro.php"><?php translate('MultiBank Pro'); ?></a></li>
                                <li><a href="/multibankfx/platforms/maximus.php"><?php translate('Maximus'); ?></a></li>
                                <li><a href="/multibankfx/platforms/mt5-platform.php"><?php translate('MT5 Platform'); ?></a></li>
                ...
                <li class="nav-accounts-menu header-nav-menu" style="display: none;">
                    <div class="w-75 mx-auto row">
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="menu_txt_content">
                                <div class="mex-h2 uppercase mb0"><a class="font-40  text-left mex-p-l-none mex-p-r-none" href="account.php"><?php translate('Accounts
                                        & Funding'); ?></a></div>
                        ...
                        <div class="col-md-4 col-sm-12  col-xs-12 nav-col-hr">
                            ...
                            <ul class="nav-menu-list">
                                ...
                                <li><a href="/multibankfx/account/account-forms.php"><?php translate('Account Forms'); ?></a></li>
                ...
                <li class="nav-tools-menu header-nav-menu" style="display: none;">
                    <div class="w-75 mx-auto row">
                        <div class="col-md-4 col-sm-12  col-xs-12 ">
                            <div class="menu_txt_content">
                                <div class="mex-h2 uppercase mb0"><a class="font-40  text-left mex-p-l-none mex-p-r-none" href="tools.php"><?php translate('Tools'); ?></a>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-12  col-xs-12 nav-col-hr">
                            ...
                            <ul class="nav-menu-list">
                                ...
                                <li><a href="/multibankfx/tools/holiday-hours-notices.php"><?php translate('Trading Hours & Holiday Notice'); ?></a>
                                </li>
                ...
                <li class="nav-partnership-menu header-nav-menu" style="display: none;">
                    <div class="w-75 mx-auto row">
                        <div class="col-md-4 col-sm-12  col-xs-12 ">
                            <div class="menu_txt_content">
                                <div class="mex-h2 uppercase mb0"><a class="font-40 text-left mex-p-l-none mex-p-r-none" href="investor-relations.php"><?php translate('Partnership'); ?></a>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-12  col-xs-12 nav-col-hr">
                            <div class="nav-menu-heading">
                                <h4 class="uppercase mb0"><a class="font-24" href="/multibankfx/investor-relations.php"><?php translate('Partnership'); ?></a></h4>
                            </div>
                            <ul class="nav-menu-list">
                                ...
                                <li><a href="/multibankfx/partnership/white-label.php"><?php translate('White Label'); ?></a></li>
                                <li><a href="/multibankfx/partnership/prime-of-primes.php"><?php translate('Prime of Primes'); ?></a></li>
                                <li><a href="/multibankfx/partnership/cpa-affiliate-program.php"><?php translate('CPA Affiliate Program'); ?></a></li>
                            </ul>
                        </div>
                        <div class="col-md-4 col-sm-12  col-xs-12 ">
                            <div class="menu_ad">
            ...
            <ul class="nav-menu-mobile text-uppercase">
                ...
                <li class="nav-menu-mobile-section py-1 mx-4"><a href="/multibankfx/tools.php"><?php translate('Tools'); ?></a>
                    <ul class="text-center">
                        <li><a href="/multibankfx/tools/trading-tools.php"><?php translate('Trading Tools'); ?></a></li>
                        <li><a href="/multibankfx/tools/trading-conditions.php"><?php translate('Trading Conditions'); ?></a></li>
                        <li><a href="/multibankfx/tools/holiday-hours-notices.php"><?php translate('Trading Hours & Holiday Notice'); ?></a></li>
                        <li><a href="/multibankfx/cfd-expiration-dates.php"><?php translate('CFD Expiration Dates'); ?></a></li>
