...
<body>
    ...
    <section class="signal-provider">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-6">
                    <strong>As a Trader, Grow Your Wealth through Increased Profits</strong>
                    <h1 class="text-005190 mex-h2 st-h2">Become a Signal provider & expand your income stream</h1>
                    <p class="st-h3">
                        We know that consisitently profitable traders are hard to come by. You've spent
                        months and years developing your trading strategies and discipline.
                    </p>
                    <p class="st-h3">
                    ...
                    <ul class="text-005190 st-grow-wealth-list fa-ul">
                        <li><span class="fa-li"><i class="fa fa-check-circle"></i></span>Proffessional global brokerage operating No Dealing Desk(NDD) execution on aggregated executable prices, offering the lowest spreads in the industry</li>
                        <li><span class="fa-li"><i class="fa fa-check-circle"></i></span>Share your trading strategies to our 320,000+ customers and make profits for
                            each additional Investor that copies your trade</li>
                        <li><span class="fa-li"><i class="fa fa-check-circle"></i></span>Unlimited profit potential- the more Investors who copy your trade, the more
                            money you earn!</li>
                    </ul>
                    <p class="st-h3">
                    ...
                    <div class="row mex-m-t-10 mx-0">
                        <a href=" https://invest.multibankfx.com" class="btn-st-005190 ml-0 text-fff">join as signal provider</a>
                    </div>
                </div>
    ...
    <section class="how-it-works p0" style="background-color:#112754;">
        <div class="col-12 row">
            ...
            <div class="col-lg-5" style="align-self:center;">
                ...
                <div class="mex-content text-fff mex-m-t-10 mex-m-b-10">
                    Investors will browse the leaderboard and select accounts they
                    want to follow. Once they subscribe to the selected accounts, our
                    social trading system will automatically copy the transactions from
                    these subsribed accounts onto their own.
                </div>
            </div>
        </div>
    </section>
    <section class="payout-methods">
        <div class="container">
            <div class="row text-center">
                <div class="col-12 mb-3">
                    <div class="text-005190 mex-h2 st-h2">Automatic Payouts To Signal Providers</div>
                ...
                <div class="mt-5 col-12 justify-content-center">
                    <a href=" https://invest.multibankfx.com" class="btn-st-005190 m-0 text-fff">join as signal provider</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-md-6 align-self-center">
                    <div class="text-005190 mex-h2 st-h2 mex-m-b-20">Enjoy Financial Freedom with MultiBank Social Trading!</div>
                    <div class="mex-content">
                        <p class="mex-m-b-10">Trading as a Signal Provider is much less risky while significantly more profitable than trading as an individual trader.</p>
                        <p class="mex-m-b-10">This is because when individual traders want trading to be their main source of income, it requires them to undertake much higher risk in order to meet their target profits. </p>
                        <p class="mex-m-b-10">With Signal Providers, they can generate much larger income stream with minimal risk because they can practice conservative trading strategies and simply increase their profit stream through accumulation of a large subscriber base.</p>
                    </div>
                    <div class="row mex-m-t-10 mx-0">
                        <a href=" https://invest.multibankfx.com" class="btn-st-005190 ml-0 text-fff">join as signal provider</a>
                    </div>
        ...
        <div class="container">
            <div class="row ">
                <div class="col-12 col-md-6 align-self-center">
                    <div class="text-005190 mex-h2 st-h2 mb-3">Limit your risk as a signal provider</div>
                    <div class="mb-3">Signal Providers can set daily risk limits to protect themselves and their Investors from losses due to volatile market.
                    </div>
                    ...
                    <ol style="padding-left: 20px; margin-left: 0">
                        <li class="mb-3">
                            The Signal Provider/ Investor can set a daily risk limit on their trading account. The daily risk limit is calculated as a percentage of equity based on equity available at the beginning of the trading day (00:00 server time).
                        </li>
                        <li>
                            If the Signal Provider/ Investor is losing money and reaches the daily risk limit, all opened positions will be closed by market orders and the account will be turned into read-only mode until the end of that trading day.
                        </li>
                    </ol>
                </div>
                <div class="col-12 col-md-6">
    ...
    <section class="how-it-works p0" style="background-color:#112754;">
        <div class="col-12 row">
            ...
            <div class="col-12 col-lg-5" style="align-self:center;">
                ...
                <div class="mex-content text-fff mex-m-t-10">
                    <p class="mex-m-b-10">As a Signal Provider on our social trading platform, you have the opportunity to access a large network of Investors who are looking to copy your successful trades. You can now start earning significant income every time a new Investor copies your trades!</p>
                    <p class="mex-m-b-10">The more money they invest, the more money you make. </p>
                </div>
                <div class="row mx-0">
                    <a href=" https://invest.multibankfx.com" class="btn-st-006AD0 mex-m-t-10 ml-0 text-fff">Join As Signal Provider</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container row">
            <div class="col-12 col-md-7 mx-auto bg-white p-4">
                ...
                <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                    <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1NjoyMg==' />
                    <input type='hidden' name='token' value='$2y$10$443grws2sGcZo0AZUgBsKe4uSRgvrr7IFQxc2uahDXP6twHVFZ.G2' />
                    <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:55:36] https://www.multibankfx.com/about/company-news<br/><br/>[2020-06-27 02:55:38] https://www.multibankfx.com/about/company-news<br/><br/>[2020-06-27 02:55:39] https://www.multibankfx.com/about/company-news<br/><br/>[2020-06-27 02:56:22] https://www.multibankfx.com/social-trading<br/><br/> <br/><br/> posted From: www.multibankfx.com/social-trading/trader?web=true' />
