...
<body>
    ...
    <section class="st-section">
        ...
        <div class="container text-center mex-p-v-80 row justify-content-end mx-auto">
            <div class="col-lg-6 col-md-6 col-sm-8 col-12">
                ...
                <div class="text-fff text-left">MultiBank’s social trading platform aggregates the performance of all our Signal Providers accounts and displays the most profitable and best performing accounts at the top.Click on each Master Account below to find more details about each account’s specific trading history and record.</div>
            </div>
        </div>
    </section>
    ...
    <section style="background-color: #fff">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <p class="st-h4 text-uppercase text-005190">JOIN SUCCESS OF PROFESSIONALS</p>
                    <p class="mex-h2 st-h2">INVESTMENTS IN TRADERS REIMAGINED</p>
                    <p class="st-h4">Subscribe to one or several traders and get their positions copied to your account automatically. See how profitable traders open and close their positions. Learn by doing. You maintain a full control over your account and can make your own trades on it.</p>
                    <ul class="text-005190 st-grow-wealth-list fa-ul">
                        <li><span class="fa-li"><i class="fa fa-check-circle"></i></span>Get passive income</li>
    ...
    $('.nav-link').click(function() {
            ...
            <div class="container row">
                <div class="col-12 col-md-7 mx-auto bg-white p-4">
                    ...
                    <form action="https://www.multibankfx.com/form/contactus?" name='email_us_form' class='multibank-form row mx-0 w-100 new' method='post' enctype='' id='email_us_form' target='' autocomplete='on'>
                        <input type='hidden' name='t_date' value='MjAyMC0wNi0yNyAwMjo1NjoyNw==' />
                        <input type='hidden' name='token' value='$2y$10$Q1nwU3HQSsS6rWjIVP50t.ZQQIgrSzylKxHRTpgelIuvI6sss748a' />
                        <input type='hidden' name='source' value='[2020-06-27 02:49:03] https://www.multibankfx.com/<br/><br/>[2020-06-27 02:56:22] https://www.multibankfx.com/social-trading<br/><br/>[2020-06-27 02:56:24] https://www.multibankfx.com/social-trading<br/><br/>[2020-06-27 02:56:25] https://www.multibankfx.com/social-trading<br/><br/>[2020-06-27 02:56:27] https://www.multibankfx.com/social-trading<br/><br/> <br/><br/> posted From: www.multibankfx.com/social-trading/leaderboard?web=true' />
                        ...
                        </div><button type='submit' class='btn btn-mex ml-auto btn-submit' onsubmit="if (!window.__cfRLUnblockHandlers) return false; " data-cf-modified-49f47bde30750ed64190b3d3-="">SEND</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7089c43e/cloudflare-static/rocket-loader.min.js" data-cf-settings="49f47bde30750ed64190b3d3-|49" defer=""></script>
</body>
